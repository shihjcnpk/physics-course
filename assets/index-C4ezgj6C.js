...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“测量值由数值和单位组成”。  \r
   **答案**：必须同时说出物理对象和关系：选量程、分度值、估读并记录。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“选量程、分度值、估读并记录”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C9漏读分度值”。\r
3. **图示应用**：请画一张“刻度尺读数图”，用图解释“选量程、分度值、估读并记录”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：尺上12.30 cm表示精确到毫米并估读一位。  \r
   **答案**：12.30 cm；末位是估读。关键模型：选量程、分度值、估读并记录。\r
5. **情境与错因侦探**：同学完成“测书本宽度并测30次脉搏时间”后出现“C6单位错误”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C6单位错误**。先检查与“选量程、分度值、估读并记录”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“机械运动是位置随时间改变”。  \r
   **答案**：必须同时说出物理对象和关系：相对参照物比较位置。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“相对参照物比较位置”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4漏参照物”。\r
3. **图示应用**：请画一张“参照物位置对比图”，用图解释“相对参照物比较位置”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：坐在行驶列车中的人相对座椅静止、相对站台运动。  \r
   **答案**：两种说法都对，关键是参照物不同。关键模型：相对参照物比较位置。\r
5. **情境与错因侦探**：同学完成“玩具车旁放橡皮，分别以桌面和车为参照观察”后出现“C1把运动说成绝对”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1把运动说成绝对**。先检查与“相对参照物比较位置”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“速度描述运动快慢”。  \r
   **答案**：必须同时说出物理对象和关系：单位时间通过的路程。只重复标题不算完成。\r
2. **条件辨认**：写出v=s/t中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6单位错误”。\r
3. **图示应用**：请画一张“路程时间条形图”，用图解释“单位时间通过的路程”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：60 m用12 s，速度是多少。  \r
   **答案**：5 m/s，表示每秒通过5 m。关键模型：单位时间通过的路程。\r
5. **情境与错因侦探**：同学完成“比较两辆玩具车不同路程与时间，统一到每1秒”后出现“C5除法错误”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C5除法错误**。先检查与“单位时间通过的路程”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“平均速度对应一段总过程”。  \r
   **答案**：必须同时说出物理对象和关系：总路程除以总时间。只重复标题不算完成。\r
2. **条件辨认**：写出v平均=s总/t总中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7速度直接平均”。\r
3. **图示应用**：请画一张“分段时间轴”，用图解释“总路程除以总时间”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：前10 m用2 s、后10 m用3 s，整段平均速度。  \r
   **答案**：20/5=4 m/s，不能平均两个速度。关键模型：总路程除以总时间。\r
5. **情境与错因侦探**：同学完成“走快10 m再慢走10 m，记录各段和总时间”后出现“C2分段模型错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2分段模型错**。先检查与“总路程除以总时间”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“速度由同一段的路程和时间得到”。  \r
   **答案**：必须同时说出物理对象和关系：测距、计时、配对、计算。只重复标题不算完成。\r
2. **条件辨认**：写出v=s/t中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C8只测一次”。\r
3. **图示应用**：请画一张“斜面小车测量图”，用图解释“测距、计时、配对、计算”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：0.8 m用1.6 s，速度是多少。  \r
   **答案**：0.50 m/s；路程和时间必须来自同一段。关键模型：测距、计时、配对、计算。\r
5. **情境与错因侦探**：同学完成“在缓斜面标两段，重复计时并记录数据”后出现“C4数据配错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4数据配错**。先检查与“测距、计时、配对、计算”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“声音由振动产生并需介质传播”。  \r
   **答案**：必须同时说出物理对象和关系：声源振动→介质传递→耳接收。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“声源振动→介质传递→耳接收”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2漏介质”。\r
3. **图示应用**：请画一张“振动传播链图”，用图解释“声源振动→介质传递→耳接收”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：太空舱外爆炸能否直接听见。  \r
   **答案**：不能；真空不能传声。关键模型：声源振动→介质传递→耳接收。\r
5. **情境与错因侦探**：同学完成“摸喉咙、拨橡皮筋，再用纸杯电话比较”后出现“C1把声音当物质”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1把声音当物质**。先检查与“声源振动→介质传递→耳接收”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“声音有音调、响度、音色三种特性”。  \r
   **答案**：必须同时说出物理对象和关系：频率管高低、振幅管强弱、音色辨声源。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“频率管高低、振幅管强弱、音色辨声源”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3波形读错”。\r
3. **图示应用**：请画一张“三种波形对比图”，用图解释“频率管高低、振幅管强弱、音色辨声源”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：用力拨同一根弦主要改变什么。  \r
   **答案**：响度；弦的振动频率近似不变。关键模型：频率管高低、振幅管强弱、音色辨声源。\r
5. **情境与错因侦探**：同学完成“弹不同长度橡皮筋并改变拨动力度”后出现“C1三特性混淆”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1三特性混淆**。先检查与“频率管高低、振幅管强弱、音色辨声源”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“声可传递信息和能量”。  \r
   **答案**：必须同时说出物理对象和关系：声源—传播—接收三处分析。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“声源—传播—接收三处分析”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4忽略情境”。\r
3. **图示应用**：请画一张“噪声三环节图”，用图解释“声源—传播—接收三处分析”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：给临街房间选降噪措施。  \r
   **答案**：关窗主要在传播途径减弱噪声。关键模型：声源—传播—接收三处分析。\r
5. **情境与错因侦探**：同学完成“用软布包住响铃，比较声源与传播途径控制”后出现“C2控制环节混乱”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2控制环节混乱**。先检查与“声源—传播—接收三处分析”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“温度表示冷热程度”。  \r
   **答案**：必须同时说出物理对象和关系：测温物质随温度规律变化。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“测温物质随温度规律变化”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6漏摄氏度”。\r
3. **图示应用**：请画一张“温度计读数图”，用图解释“测温物质随温度规律变化”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：温度计示数在0下4格、每格1℃。  \r
   **答案**：−4℃；视线与液柱顶端相平。关键模型：测温物质随温度规律变化。\r
5. **情境与错因侦探**：同学完成“三杯水先用手判断再用温度计测量”后出现“C3读数方向错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3读数方向错**。先检查与“测温物质随温度规律变化”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“同种物质可处于固液气三态”。  \r
   **答案**：必须同时说出物理对象和关系：三态之间六种变化方向。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“三态之间六种变化方向”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3箭头反向”。\r
3. **图示应用**：请画一张“三态六箭头图”，用图解释“三态之间六种变化方向”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：冰变水属于什么变化。  \r
   **答案**：熔化：固态到液态。关键模型：三态之间六种变化方向。\r
5. **情境与错因侦探**：同学完成“观察冰融化和杯外水珠，只先标起点与终点”后出现“C1把水珠说成杯中渗出”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1把水珠说成杯中渗出**。先检查与“三态之间六种变化方向”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“晶体在一定条件下有确定熔点”。  \r
   **答案**：必须同时说出物理对象和关系：晶体熔化时吸热、温度保持在熔点。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“晶体熔化时吸热、温度保持在熔点”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C1把不升温当不吸热”。\r
3. **图示应用**：请画一张“熔化曲线图”，用图解释“晶体熔化时吸热、温度保持在熔点”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：加热晶体的曲线出现温度平台，同时仍有固液两态，说明什么。  \r
   **答案**：晶体正在熔化，继续吸热但温度保持在熔点。关键模型：晶体熔化时吸热、温度保持在熔点。\r
5. **情境与错因侦探**：同学完成“用碎冰和温度计观察，或读取规范实验数据”后出现“C3平台读错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3平台读错**。先检查与“晶体熔化时吸热、温度保持在熔点”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“沸腾在内部和表面同时汽化”。  \r
   **答案**：必须同时说出物理对象和关系：持续吸热但沸腾时温度近似不变。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“持续吸热但沸腾时温度近似不变”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C8用一次读数下结论”。\r
3. **图示应用**：请画一张“沸腾装置与曲线图”，用图解释“持续吸热但沸腾时温度近似不变”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：水沸腾后读数保持98℃说明什么。  \r
   **答案**：当地条件下沸点约98℃，继续吸热用于汽化。关键模型：持续吸热但沸腾时温度近似不变。\r
5. **情境与错因侦探**：同学完成“按分钟记录温度和气泡，画温度—时间图”后出现“C3图像轴错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3图像轴错**。先检查与“持续吸热但沸腾时温度近似不变”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“蒸发可在任何温度发生，液化会放热”。  \r
   **答案**：必须同时说出物理对象和关系：液体↔气体的能量过程。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“液体↔气体的能量过程”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2水珠来源错”。\r
3. **图示应用**：请画一张“蒸发条件对比图”，用图解释“液体↔气体的能量过程”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：夏天冰饮料杯外水珠来自哪里。  \r
   **答案**：空气中水蒸气液化，不是杯内渗水。关键模型：液体↔气体的能量过程。\r
5. **情境与错因侦探**：同学完成“两滴等量水分别摊开与成滴，比较干燥速度”后出现“C1蒸发等同沸腾”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1蒸发等同沸腾**。先检查与“液体↔气体的能量过程”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“物质可直接在固态和气态间变化”。  \r
   **答案**：必须同时说出物理对象和关系：固↔气与水循环状态链。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“固↔气与水循环状态链”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4忽略冷热位置”。\r
3. **图示应用**：请画一张“水循环箭头图”，用图解释“固↔气与水循环状态链”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：窗上冰花通常形成在哪一侧。  \r
   **答案**：室内侧；水蒸气遇冷凝华。关键模型：固↔气与水循环状态链。\r
5. **情境与错因侦探**：同学完成“观察冷冻室霜或碘升华视频，只追踪物质去向”后出现“C3状态箭头错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3状态箭头错**。先检查与“固↔气与水循环状态链”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“光在同种均匀介质中沿直线传播”。  \r
   **答案**：必须同时说出物理对象和关系：用光线表示传播路径。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“用光线表示传播路径”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3光线不画箭头”。\r
3. **图示应用**：请画一张“三孔与影子光路图”，用图解释“用光线表示传播路径”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：影子怎样形成。  \r
   **答案**：光沿直线传播，物体挡住部分光。关键模型：用光线表示传播路径。\r
5. **情境与错因侦探**：同学完成“让手电筒光通过三张带孔纸，移动中间纸”后出现“C1漏适用条件”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1漏适用条件**。先检查与“用光线表示传播路径”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“反射光线、入射光线和法线在同一平面内”。  \r
   **答案**：必须同时说出物理对象和关系：反射角等于入射角，两线分居法线两侧。只重复标题不算完成。\r
2. **条件辨认**：写出∠r=∠i中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C8由一组数据定律”。\r
3. **图示应用**：请画一张“反射光路图”，用图解释“反射角等于入射角，两线分居法线两侧”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：入射光与镜面夹30°，反射角是多少。  \r
   **答案**：60°；入射角和反射角都相对法线测量。关键模型：反射角等于入射角，两线分居法线两侧。\r
5. **情境与错因侦探**：同学完成“用平面镜、纸屏和量角器改变入射角测三组数据”后出现“C3角相对镜面量”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3角相对镜面量**。先检查与“反射角等于入射角，两线分居法线两侧”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“平面镜成等大正立虚像”。  \r
   **答案**：必须同时说出物理对象和关系：像物关于镜面对称。只重复标题不算完成。\r
2. **条件辨认**：写出像距=物距中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C5漏总距离”。\r
3. **图示应用**：请画一张“玻璃板成像图”，用图解释“像物关于镜面对称”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：人离镜1 m，像离人多远。  \r
   **答案**：2 m；像在镜后1 m。关键模型：像物关于镜面对称。\r
5. **情境与错因侦探**：同学完成“玻璃板前后用两支相同蜡烛定位像，再放光屏”后出现“C3把像画成实线光线会聚”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3把像画成实线光线会聚**。先检查与“像物关于镜面对称”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“光斜入不同介质时传播方向通常改变”。  \r
   **答案**：必须同时说出物理对象和关系：入射介质—界面—折射光线模型。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“入射介质—界面—折射光线模型”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7背方向不看传播介质”。\r
3. **图示应用**：请画一张“空气水界面光路图”，用图解释“入射介质—界面—折射光线模型”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：从空气斜射入水，光线通常靠近哪条线。  \r
   **答案**：法线。关键模型：入射介质—界面—折射光线模型。\r
5. **情境与错因侦探**：同学完成“激光斜射入水，观察并画入射与折射路径”后出现“C3法线漏画”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3法线漏画**。先检查与“入射介质—界面—折射光线模型”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“凸透镜会聚、凹透镜发散”。  \r
   **答案**：必须同时说出物理对象和关系：三条特殊光线建立透镜模型。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“三条特殊光线建立透镜模型”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3折射光线方向错”。\r
3. **图示应用**：请画一张“凸凹透镜光路图”，用图解释“三条特殊光线建立透镜模型”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：平行光经凸透镜后经过哪里。  \r
   **答案**：焦点。关键模型：三条特殊光线建立透镜模型。\r
5. **情境与错因侦探**：同学完成“用手电筒和平行光纸卡观察两类透镜后的光束”后出现“C1凭厚薄认错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1凭厚薄认错**。先检查与“三条特殊光线建立透镜模型”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“像的性质随物距区间改变”。  \r
   **答案**：必须同时说出物理对象和关系：物距—焦距区间决定像的位置与性质。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“物距—焦距区间决定像的位置与性质”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C8找不到像就下结论”。\r
3. **图示应用**：请画一张“光具座区间图”，用图解释“物距—焦距区间决定像的位置与性质”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：物距大于2f时像有何特点。  \r
   **答案**：倒立、缩小、实像，像在f与2f之间。关键模型：物距—焦距区间决定像的位置与性质。\r
5. **情境与错因侦探**：同学完成“固定焦距，改变物距并在光屏上找清晰像”后出现“C4未先比较u与f”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4未先比较u与f**。先检查与“物距—焦距区间决定像的位置与性质”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“不同物距区间对应不同应用”。  \r
   **答案**：必须同时说出物理对象和关系：成像区间→器件功能。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“成像区间→器件功能”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C1虚像可接屏”。\r
3. **图示应用**：请画一张“三种应用对比图”，用图解释“成像区间→器件功能”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：近视眼用什么透镜矫正。  \r
   **答案**：凹透镜，使光先发散再进入眼睛。关键模型：成像区间→器件功能。\r
5. **情境与错因侦探**：同学完成“用凸透镜分别看近字和远景，比较能否在纸上接像”后出现“C2器件区间混淆”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2器件区间混淆**。先检查与“成像区间→器件功能”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“质量不随形状、状态、位置轻易改变”。  \r
   **答案**：必须同时说出物理对象和关系：天平比较物体质量。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“天平比较物体质量”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C9天平未调平”。\r
3. **图示应用**：请画一张“天平平衡图”，用图解释“天平比较物体质量”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：砝码50 g、游码2.4 g，物体质量。  \r
   **答案**：52.4 g。关键模型：天平比较物体质量。\r
5. **情境与错因侦探**：同学完成“按调平—左物右码—读数测木块和水质量”后出现“C6千克克换算错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C6千克克换算错**。先检查与“天平比较物体质量”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“密度是单位体积的质量”。  \r
   **答案**：必须同时说出物理对象和关系：质量—体积比率模型。只重复标题不算完成。\r
2. **条件辨认**：写出ρ=m/V中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6密度单位错”。\r
3. **图示应用**：请画一张“等体积质量对比图”，用图解释“质量—体积比率模型”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：质量178 g、体积20 cm³，密度。  \r
   **答案**：8.9 g/cm³。关键模型：质量—体积比率模型。\r
5. **情境与错因侦探**：同学完成“比较等体积水和食用油质量，统一到1 cm³”后出现“C5比值颠倒”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C5比值颠倒**。先检查与“质量—体积比率模型”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“密度测量需配对同一物体的质量和体积”。  \r
   **答案**：必须同时说出物理对象和关系：天平测质量、排水测体积、计算密度。只重复标题不算完成。\r
2. **条件辨认**：写出ρ=m/V中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C5体积差错”。\r
3. **图示应用**：请画一张“量筒排水图”，用图解释“天平测质量、排水测体积、计算密度”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：石块54 g，水从30到50 mL，密度。  \r
   **答案**：2.7 g/cm³。关键模型：天平测质量、排水测体积、计算密度。\r
5. **情境与错因侦探**：同学完成“测石块质量，再读放入前后水体积差；另测液体密度”后出现“C4质量体积非同一对象”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4质量体积非同一对象**。先检查与“天平测质量、排水测体积、计算密度”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“物质属性来自结构并服务技术选择”。  \r
   **答案**：必须同时说出物理对象和关系：属性—用途—尺度证据链。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“属性—用途—尺度证据链”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4忽略选择条件”。\r
3. **图示应用**：请画一张“宏观到微观尺度轴”，用图解释“属性—用途—尺度证据链”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：锅身和锅柄应分别看重什么属性。  \r
   **答案**：锅身导热好，锅柄导热差且耐热。关键模型：属性—用途—尺度证据链。\r
5. **情境与错因侦探**：同学完成“比较金属和木材导热，给原子到宇宙排序”后出现“C1把用途当属性”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1把用途当属性**。先检查与“属性—用途—尺度证据链”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“力是物体对物体的作用”。  \r
   **答案**：必须同时说出物理对象和关系：施力物—受力物成对分析。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“施力物—受力物成对分析”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2漏相互作用”。\r
3. **图示应用**：请画一张“相互作用对象图”，用图解释“施力物—受力物成对分析”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：脚踢球时谁受力。  \r
   **答案**：球受脚的力，脚也受球的力。关键模型：施力物—受力物成对分析。\r
5. **情境与错因侦探**：同学完成“挤气球、推墙，分别说出施力物和受力物”后出现“C1只说“有力”不说对象”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1只说“有力”不说对象**。先检查与“施力物—受力物成对分析”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“力有大小、方向、作用点”。  \r
   **答案**：必须同时说出物理对象和关系：用带比例或标值箭头表示力。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“用带比例或标值箭头表示力”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6漏力值单位”。\r
3. **图示应用**：请画一张“规范力箭头图”，用图解释“用带比例或标值箭头表示力”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：画水平向右5 N的推力。  \r
   **答案**：箭头起于作用点、向右并标F=5 N。关键模型：用带比例或标值箭头表示力。\r
5. **情境与错因侦探**：同学完成“在门上不同位置推，画出作用点和方向”后出现“C3箭头起点错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3箭头起点错**。先检查与“用带比例或标值箭头表示力”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“重力是地球对物体的吸引”。  \r
   **答案**：必须同时说出物理对象和关系：重心处竖直向下。只重复标题不算完成。\r
2. **条件辨认**：写出G=mg中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6质量单位未化kg”。\r
3. **图示应用**：请画一张“斜面重力图”，用图解释“重心处竖直向下”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：2 kg物体重力约多少，取g=10 N/kg。  \r
   **答案**：20 N，方向竖直向下。关键模型：重心处竖直向下。\r
5. **情境与错因侦探**：同学完成“悬挂小重物观察重垂线，再在斜面图画重力”后出现“C3把竖直当垂直斜面”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3把竖直当垂直斜面**。先检查与“重心处竖直向下”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“弹性形变产生弹力且有弹性限度”。  \r
   **答案**：必须同时说出物理对象和关系：在限度内形变量反映力大小。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“在限度内形变量反映力大小”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7超过量程仍使用”。\r
3. **图示应用**：请画一张“测力计读数图”，用图解释“在限度内形变量反映力大小”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：测力计每大格1 N分5小格，指3小格。  \r
   **答案**：0.6 N。关键模型：在限度内形变量反映力大小。\r
5. **情境与错因侦探**：同学完成“检查零点、量程、分度值，体验并测量1 N与书的重力”后出现“C9未校零”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C9未校零**。先检查与“在限度内形变量反映力大小”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“滑动摩擦与压力和接触面粗糙程度有关”。  \r
   **答案**：必须同时说出物理对象和关系：水平匀速时拉力等于摩擦力。只重复标题不算完成。\r
2. **条件辨认**：写出F拉=f中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4同时改两个变量”。\r
3. **图示应用**：请画一张“水平匀速测摩擦图”，用图解释“水平匀速时拉力等于摩擦力”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：研究粗糙程度时什么必须相同。  \r
   **答案**：压力等条件相同。关键模型：水平匀速时拉力等于摩擦力。\r
5. **情境与错因侦探**：同学完成“只改变压力或粗糙程度，匀速拉木块记录力”后出现“C2未利用平衡间接测量”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2未利用平衡间接测量**。先检查与“水平匀速时拉力等于摩擦力”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“力不是维持运动的原因”。  \r
   **答案**：必须同时说出物理对象和关系：阻力逐渐减小→运动保持更久→理想无阻力。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“阻力逐渐减小→运动保持更久→理想无阻力”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2实验结论直接等同无阻力”。\r
3. **图示应用**：请画一张“斜面小车推理图”，用图解释“阻力逐渐减小→运动保持更久→理想无阻力”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：运动物体不受力将怎样。  \r
   **答案**：保持匀速直线运动。关键模型：阻力逐渐减小→运动保持更久→理想无阻力。\r
5. **情境与错因侦探**：同学完成“比较毛巾、木板、玻璃面上小车滑行距离并外推”后出现“C1把力当维持运动”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1把力当维持运动**。先检查与“阻力逐渐减小→运动保持更久→理想无阻力”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“一切物体都有保持原运动状态的性质”。  \r
   **答案**：必须同时说出物理对象和关系：刹车前后分别比较人和车状态。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“刹车前后分别比较人和车状态”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4漏原状态”。\r
3. **图示应用**：请画一张“刹车状态时间轴”，用图解释“刹车前后分别比较人和车状态”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：跳远助跑为什么有用。  \r
   **答案**：起跳后身体因惯性保持较大向前速度。关键模型：刹车前后分别比较人和车状态。\r
5. **情境与错因侦探**：同学完成“抽走纸片观察硬币落杯，再口述前后状态”后出现“C1说“受到惯性力””。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1说“受到惯性力”**。先检查与“刹车前后分别比较人和车状态”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“同一直线上同向二力相加、反向二力相减；合力为零是二力平衡的特殊情况”。  \r
   **答案**：必须同时说出物理对象和关系：先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3反向相减后漏合力方向”。\r
3. **图示应用**：请画一张“同一直线二力合成与平衡图”，用图解释“先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：物体受向右6 N和向左4 N的力，合力怎样。  \r
   **答案**：合力为2 N，方向向右；若两力等大反向且作用在同一物体同一直线上，合力才为零。关键模型：先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线。\r
5. **情境与错因侦探**：同学完成“用两端钩码拉卡片，先比较同向与反向合力，再让反向二力等大观察平衡”后出现“C2把相互作用力当平衡力”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2把相互作用力当平衡力**。先检查与“先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“压强表示单位面积承受的压力”。  \r
   **答案**：必须同时说出物理对象和关系：压力与受力面积共同决定效果。只重复标题不算完成。\r
2. **条件辨认**：写出p=F/S中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7只看压力”。\r
3. **图示应用**：请画一张“压力面积对比图”，用图解释“压力与受力面积共同决定效果”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：600 N站在0.04 m²地面，压强。  \r
   **答案**：15000 Pa。关键模型：压力与受力面积共同决定效果。\r
5. **情境与错因侦探**：同学完成“同一块橡皮分别平放和竖放在海绵上”后出现“C5面积换算错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C5面积换算错**。先检查与“压力与受力面积共同决定效果”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“液体内部向各方向有压强”。  \r
   **答案**：必须同时说出物理对象和关系：同种液体压强随深度增加；同深度看密度。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“同种液体压强随深度增加；同深度看密度”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C8一次数据下结论”。\r
3. **图示应用**：请画一张“压强计深度图”，用图解释“同种液体压强随深度增加；同深度看密度”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：研究深度影响时保持什么相同。  \r
   **答案**：液体种类和探头方向等相同。关键模型：同种液体压强随深度增加；同深度看密度。\r
5. **情境与错因侦探**：同学完成“改变探头深度、方向和液体种类，观察U形管高度差”后出现“C4把离容器底距离当深度”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4把离容器底距离当深度**。先检查与“同种液体压强随深度增加；同深度看密度”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“大气有压强且向各方向作用”。  \r
   **答案**：必须同时说出物理对象和关系：内外压强差产生效果。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“内外压强差产生效果”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2漏压强差”。\r
3. **图示应用**：请画一张“吸盘压强差图”，用图解释“内外压强差产生效果”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：吸管吸饮料是谁把液体压上来。  \r
   **答案**：大气压把液体压入低压的吸管。关键模型：内外压强差产生效果。\r
5. **情境与错因侦探**：同学完成“用装水杯和纸片倒置，观察纸片不落”后出现“C1说嘴把水“吸上来””。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1说嘴把水“吸上来”**。先检查与“内外压强差产生效果”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“在常见稳定流动比较中，流速较大处压强较小”。  \r
   **答案**：必须同时说出物理对象和关系：两侧流速差→压强差→受力。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“两侧流速差→压强差→受力”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3压强箭头反”。\r
3. **图示应用**：请画一张“机翼流线图”，用图解释“两侧流速差→压强差→受力”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：火车站安全线为什么要退后。  \r
   **答案**：列车旁空气流速较大、压强较小，外侧压强可能把人推近。关键模型：两侧流速差→压强差→受力。\r
5. **情境与错因侦探**：同学完成“平行悬挂两纸条，从中间吹气并预测”后出现“C1说气流把纸吹开”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1说气流把纸吹开**。先检查与“两侧流速差→压强差→受力”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“浮力是流体对浸入物体向上的作用”。  \r
   **答案**：必须同时说出物理对象和关系：弹簧测力计示数差测浮力。只重复标题不算完成。\r
2. **条件辨认**：写出F浮=G-F示中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3漏竖直向上”。\r
3. **图示应用**：请画一张“称重法受力图”，用图解释“弹簧测力计示数差测浮力”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：空气5 N、水中3 N，浮力。  \r
   **答案**：2 N。关键模型：弹簧测力计示数差测浮力。\r
5. **情境与错因侦探**：同学完成“先在空气再浸水读取测力计，比较示数”后出现“C2把示数当浮力”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2把示数当浮力**。先检查与“弹簧测力计示数差测浮力”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“浮力与排开液体体积、液体密度有关”。  \r
   **答案**：必须同时说出物理对象和关系：控制变量比较称重差。只重复标题不算完成。\r
2. **条件辨认**：写出F浮=G-F示中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C8触底数据仍采用”。\r
3. **图示应用**：请画一张“浸入体积对比图”，用图解释“控制变量比较称重差”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：完全浸没后继续下沉，浮力通常怎样。  \r
   **答案**：若液体密度不变且未触底，浮力不变。关键模型：控制变量比较称重差。\r
5. **情境与错因侦探**：同学完成“改变浸入体积、液体种类；完全浸没后再改深度”后出现“C4把深度与排开体积混淆”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4把深度与排开体积混淆**。先检查与“控制变量比较称重差”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“浮力等于排开流体所受重力”。  \r
   **答案**：必须同时说出物理对象和关系：排液质量→排液重力→浮力。只重复标题不算完成。\r
2. **条件辨认**：写出F浮=G排=ρ液gV排中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7用物体总体积代排液体积”。\r
3. **图示应用**：请画一张“溢水杯证据链图”，用图解释“排液质量→排液重力→浮力”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：排开0.2 kg水，取g=10，浮力。  \r
   **答案**：2 N。关键模型：排液质量→排液重力→浮力。\r
5. **情境与错因侦探**：同学完成“用溢水杯收集排水并比较其重与浮力”后出现“C6密度单位错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C6密度单位错**。先检查与“排液质量→排液重力→浮力”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“浮沉取决于竖直方向浮力和重力关系”。  \r
   **答案**：必须同时说出物理对象和关系：F浮与G比较；漂浮时相等。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“F浮与G比较；漂浮时相等”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3浮沉力箭头错”。\r
3. **图示应用**：请画一张“浮沉三状态图”，用图解释“F浮与G比较；漂浮时相等”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：漂浮物质量增大后排水怎样变。  \r
   **答案**：在仍能漂浮且液体不变时，会排开更多水，直到浮力重新等于重力。关键模型：F浮与G比较；漂浮时相等。\r
5. **情境与错因侦探**：同学完成“橡皮泥先团成球再捏成船形放水中”后出现“C2只比较材料密度”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2只比较材料密度**。先检查与“F浮与G比较；漂浮时相等”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“功需要力且物体沿力方向移动距离”。  \r
   **答案**：必须同时说出物理对象和关系：力与力方向距离的乘积。只重复标题不算完成。\r
2. **条件辨认**：写出W=Fs中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7有力就判做功”。\r
3. **图示应用**：请画一张“力与位移夹向图”，用图解释“力与力方向距离的乘积”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：10 N水平推物前进3 m，做功。  \r
   **答案**：30 J。关键模型：力与力方向距离的乘积。\r
5. **情境与错因侦探**：同学完成“对比推车前进、提物静止、提物水平走”后出现“C4漏力方向”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4漏力方向**。先检查与“力与力方向距离的乘积”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“功率表示单位时间做功”。  \r
   **答案**：必须同时说出物理对象和关系：功与时间的比率。只重复标题不算完成。\r
2. **条件辨认**：写出P=W/t中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6瓦特单位错”。\r
3. **图示应用**：请画一张“爬楼功时间图”，用图解释“功与时间的比率”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：做600 J功用3 s，功率。  \r
   **答案**：200 W。关键模型：功与时间的比率。\r
5. **情境与错因侦探**：同学完成“记录走与快走同一楼梯的时间，比较功率”后出现“C1功多等同功率大”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1功多等同功率大**。先检查与“功与时间的比率”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“运动和位置可储存机械能”。  \r
   **答案**：必须同时说出物理对象和关系：动能↔势能，考虑阻力时部分转为内能。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“动能↔势能，考虑阻力时部分转为内能”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C1把能量说成力”。\r
3. **图示应用**：请画一张“秋千能量条图”，用图解释“动能↔势能，考虑阻力时部分转为内能”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：小球从高处下滑时能量怎样变。  \r
   **答案**：重力势能减小、动能增大。关键模型：动能↔势能，考虑阻力时部分转为内能。\r
5. **情境与错因侦探**：同学完成“滚小球下斜面撞纸盒，改变高度或质量比较”后出现“C2忽略系统与阻力”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2忽略系统与阻力**。先检查与“动能↔势能，考虑阻力时部分转为内能”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“绕固定点转动的硬棒可抽象为杠杆”。  \r
   **答案**：必须同时说出物理对象和关系：力×力臂两侧平衡。只重复标题不算完成。\r
2. **条件辨认**：写出F1l1=F2l2中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C5比例求解错”。\r
3. **图示应用**：请画一张“杠杆五要素图”，用图解释“力×力臂两侧平衡”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：阻力20 N、阻力臂0.1 m，动力臂0.5 m。  \r
   **答案**：动力4 N。关键模型：力×力臂两侧平衡。\r
5. **情境与错因侦探**：同学完成“改变钩码位置与数量，记录平衡时力和力臂”后出现“C3力臂画成杆长”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3力臂画成杆长**。先检查与“力×力臂两侧平衡”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“机械效率表示有用功占总功的比例”。  \r
   **答案**：必须同时说出物理对象和关系：有用功、额外功与总功的能量账本。只重复标题不算完成。\r
2. **条件辨认**：写出η=W有/W总中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C5百分数错误”。\r
3. **图示应用**：请画一张“有用额外总功流图”，用图解释“有用功、额外功与总功的能量账本”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：有用功80 J、总功100 J，效率。  \r
   **答案**：80%；效率不可能超过100%。关键模型：有用功、额外功与总功的能量账本。\r
5. **情境与错因侦探**：同学完成“用定滑轮和动滑轮提同一物体，比较有用功、额外功和总功”后出现“C7说机械省功”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C7说机械省功**。先检查与“有用功、额外功与总功的能量账本”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“分子不停做无规则运动；内能是微观能量总和”。  \r
   **答案**：必须同时说出物理对象和关系：宏观温度现象连接微观模型。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“宏观温度现象连接微观模型”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2内能等同热量”。\r
3. **图示应用**：请画一张“扩散微粒图”，用图解释“宏观温度现象连接微观模型”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：同一物体、状态不变时温度升高，分子运动和内能通常怎样。  \r
   **答案**：分子无规则运动更剧烈，内能通常增大。关键模型：宏观温度现象连接微观模型。\r
5. **情境与错因侦探**：同学完成“冷水与热水各滴一滴色素，比较扩散”后出现“C1分子热运动等同物体移动”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1分子热运动等同物体移动**。先检查与“宏观温度现象连接微观模型”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“热传递和做功都能改变内能”。  \r
   **答案**：必须同时说出物理对象和关系：能量转移与能量转化两类路径。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“能量转移与能量转化两类路径”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2两路径混淆”。\r
3. **图示应用**：请画一张“内能路径图”，用图解释“能量转移与能量转化两类路径”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：压缩空气使其变热属于哪种。  \r
   **答案**：做功，机械能转化为内能。关键模型：能量转移与能量转化两类路径。\r
5. **情境与错因侦探**：同学完成“搓手、弯折铁丝、接触温水，给路径分类”后出现“C1热量说成物体含有”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1热量说成物体含有**。先检查与“能量转移与能量转化两类路径”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“比热容表示单位质量升高1℃所需热量”。  \r
   **答案**：必须同时说出物理对象和关系：质量、温差、物质共同决定吸热。只重复标题不算完成。\r
2. **条件辨认**：写出Q=cmΔT中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6科学记数法错”。\r
3. **图示应用**：请画一张“水沙升温曲线图”，用图解释“质量、温差、物质共同决定吸热”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：2 kg水升高5℃，c=4.2×10³，吸热。  \r
   **答案**：4.2×10^4 J。关键模型：质量、温差、物质共同决定吸热。\r
5. **情境与错因侦探**：同学完成“等质量水和沙接受相同加热，比较升温”后出现“C5温差用末温”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C5温差用末温**。先检查与“质量、温差、物质共同决定吸热”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“热值描述单位质量燃料完全燃烧时放出的热量”。  \r
   **答案**：必须同时说出物理对象和关系：燃料质量与完全燃烧放热的比例模型。只重复标题不算完成。\r
2. **条件辨认**：写出Q=mq中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7把热值随质量改变”。\r
3. **图示应用**：请画一张“燃料能量流图”，用图解释“燃料质量与完全燃烧放热的比例模型”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：0.1 kg燃料热值3×10^7 J/kg，完全燃烧放热。  \r
   **答案**：3×10^6 J。关键模型：燃料质量与完全燃烧放热的比例模型。\r
5. **情境与错因侦探**：同学完成“比较资料中同质量不同燃料完全燃烧的放热量并画能量链”后出现“C4漏完全燃烧条件”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4漏完全燃烧条件**。先检查与“燃料质量与完全燃烧放热的比例模型”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“能量总量守恒但转化有方向且品质会分散”。  \r
   **答案**：必须同时说出物理对象和关系：输入能量=有效+散失。只重复标题不算完成。\r
2. **条件辨认**：写出E入=E有+E散中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7效率超过100%”。\r
3. **图示应用**：请画一张“能量流桑基简图”，用图解释“输入能量=有效+散失”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：输入100 J，有用70 J，散失多少。  \r
   **答案**：30 J；守恒不等于都能再利用。关键模型：输入能量=有效+散失。\r
5. **情境与错因侦探**：同学完成“给手机充电能量流贴标签并找散失”后出现“C1守恒等同不变形式”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1守恒等同不变形式**。先检查与“输入能量=有效+散失”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“持续电流需要电源和闭合通路”。  \r
   **答案**：必须同时说出物理对象和关系：电源—导线—用电器—开关闭环。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“电源—导线—用电器—开关闭环”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3电路图元件画错”。\r
3. **图示应用**：请画一张“最简电路图”，用图解释“电源—导线—用电器—开关闭环”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：开关闭合但灯不亮先查什么。  \r
   **答案**：通路是否完整、接触是否可靠。关键模型：电源—导线—用电器—开关闭环。\r
5. **情境与错因侦探**：同学完成“电池、灯泡、开关试接，先检查短路风险”后出现“C2把电流消耗掉”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2把电流消耗掉**。先检查与“电源—导线—用电器—开关闭环”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“串联一条路径，并联多条支路”。  \r
   **答案**：必须同时说出物理对象和关系：从电流路径识别连接方式。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“从电流路径识别连接方式”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4漏节点”。\r
3. **图示应用**：请画一张“串并联路径图”，用图解释“从电流路径识别连接方式”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：家庭灯为什么并联。  \r
   **答案**：各支路可独立工作且两端电压相同。关键模型：从电流路径识别连接方式。\r
5. **情境与错因侦探**：同学完成“用两灯搭串联与并联，断开一灯观察另一灯”后出现“C3按元件摆放形状判断”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3按元件摆放形状判断**。先检查与“从电流路径识别连接方式”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电流表测通过某处的电流”。  \r
   **答案**：必须同时说出物理对象和关系：串联、正进负出、量程合适。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“串联、正进负出、量程合适”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C9量程读错”。\r
3. **图示应用**：请画一张“电流表接线图”，用图解释“串联、正进负出、量程合适”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：0～0.6 A量程每小格0.02 A，指17格。  \r
   **答案**：0.34 A。关键模型：串联、正进负出、量程合适。\r
5. **情境与错因侦探**：同学完成“识别量程和分度值，安全接入小灯泡支路”后出现“C3并联电流表”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3并联电流表**。先检查与“串联、正进负出、量程合适”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“串联各处电流相等，并联干路电流等于支路和”。  \r
   **答案**：必须同时说出物理对象和关系：节点电流守恒模型。只重复标题不算完成。\r
2. **条件辨认**：写出I=I1=I2；I干=I1+I2中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C1把电流当消耗品”。\r
3. **图示应用**：请画一张“节点电流箭头图”，用图解释“节点电流守恒模型”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：并联两支路0.2 A与0.3 A，干路。  \r
   **答案**：0.5 A。关键模型：节点电流守恒模型。\r
5. **情境与错因侦探**：同学完成“换测多个位置和不同灯泡，记录三组数据”后出现“C4只测一组”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4只测一组**。先检查与“节点电流守恒模型”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电压是形成电流的原因之一”。  \r
   **答案**：必须同时说出物理对象和关系：电压表并联在被测元件两端。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“电压表并联在被测元件两端”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C9正负接线错”。\r
3. **图示应用**：请画一张“电压表接线图”，用图解释“电压表并联在被测元件两端”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：0～3 V量程每小格0.1 V，指23格。  \r
   **答案**：2.3 V。关键模型：电压表并联在被测元件两端。\r
5. **情境与错因侦探**：同学完成“辨量程、分度值，把电压表跨接在灯泡两端”后出现“C3把电压表串联”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3把电压表串联**。先检查与“电压表并联在被测元件两端”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“串联总电压等于各部分之和，并联各支路电压相等”。  \r
   **答案**：必须同时说出物理对象和关系：回路电压分配模型。只重复标题不算完成。\r
2. **条件辨认**：写出U总=U1+U2；U=U1=U2中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4把电流规律套给电压”。\r
3. **图示应用**：请画一张“串并联电压图”，用图解释“回路电压分配模型”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：串联两灯1.2 V、1.8 V，电源电压。  \r
   **答案**：3.0 V。关键模型：回路电压分配模型。\r
5. **情境与错因侦探**：同学完成“分别测电源、各灯两端电压并换灯复测”后出现“C3测量端点错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3测量端点错**。先检查与“回路电压分配模型”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电阻表示导体对电流的阻碍作用”。  \r
   **答案**：必须同时说出物理对象和关系：同温下材料、长度、横截面积影响电阻；变阻器靠有效长度调节。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“同温下材料、长度、横截面积影响电阻；变阻器靠有效长度调节”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4不看有效段”。\r
3. **图示应用**：请画一张“变阻器有效段图”，用图解释“同温下材料、长度、横截面积影响电阻；变阻器靠有效长度调节”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：滑片远离已接下端时电阻怎样。  \r
   **答案**：有效长度变长，接入电阻增大。关键模型：同温下材料、长度、横截面积影响电阻；变阻器靠有效长度调节。\r
5. **情境与错因侦探**：同学完成“铅笔芯长短对电流影响演示，再判断变阻器接入段”后出现“C3同时接上面两个端子”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3同时接上面两个端子**。先检查与“同温下材料、长度、横截面积影响电阻；变阻器靠有效长度调节”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“同一导体温度近似不变时电流与电压成正比；电压一定时与电阻成反比”。  \r
   **答案**：必须同时说出物理对象和关系：控制变量建立I-U-R关系。只重复标题不算完成。\r
2. **条件辨认**：写出I=U/R中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7倒写关系”。\r
3. **图示应用**：请画一张“I-U图像与电路图”，用图解释“控制变量建立I-U-R关系”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：6 V加在3 Ω电阻上，电流。  \r
   **答案**：2 A。关键模型：控制变量建立I-U-R关系。\r
5. **情境与错因侦探**：同学完成“分别保持R或U不变，调变阻器测多组数据”后出现“C4控制量未保持”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4控制量未保持**。先检查与“控制变量建立I-U-R关系”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“欧姆定律只对同一段电路同一状态配对”。  \r
   **答案**：必须同时说出物理对象和关系：圈定研究对象再配U、I、R。只重复标题不算完成。\r
2. **条件辨认**：写出U=IR中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C7跨对象拼数据”。\r
3. **图示应用**：请画一张“局部电路框图”，用图解释“圈定研究对象再配U、I、R”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：0.5 A通过12 Ω电阻，电压。  \r
   **答案**：6 V。关键模型：圈定研究对象再配U、I、R。\r
5. **情境与错因侦探**：同学完成“给电路某电阻框边界，标其电压电流再计算”后出现“C2对象边界错”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2对象边界错**。先检查与“圈定研究对象再配U、I、R”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“由同一状态的U和I间接求R”。  \r
   **答案**：必须同时说出物理对象和关系：电流表串联、电压表并联、变阻器保护。只重复标题不算完成。\r
2. **条件辨认**：写出R=U/I中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C9闭合前未调最大”。\r
3. **图示应用**：请画一张“伏安法电路图”，用图解释“电流表串联、电压表并联、变阻器保护”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：2.4 V、0.3 A，电阻。  \r
   **答案**：8 Ω。关键模型：电流表串联、电压表并联、变阻器保护。\r
5. **情境与错因侦探**：同学完成“先最大电阻保护，再测三组U、I并分析”后出现“C4电表数据非同一时刻”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4电表数据非同一时刻**。先检查与“电流表串联、电压表并联、变阻器保护”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电功表示电能转化的多少”。  \r
   **答案**：必须同时说出物理对象和关系：电压、电流和时间共同决定电功。只重复标题不算完成。\r
2. **条件辨认**：写出W=UIt中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C6小时秒混用”。\r
3. **图示应用**：请画一张“电能流与电能表图”，用图解释“电压、电流和时间共同决定电功”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：220 V、2 A电器工作10 s，电功。  \r
   **答案**：4400 J。关键模型：电压、电流和时间共同决定电功。\r
5. **情境与错因侦探**：同学完成“读取家用电能表前后示数，计算一段时间的用电量”后出现“C1电功与功率混淆”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1电功与功率混淆**。先检查与“电压、电流和时间共同决定电功”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电功率表示电能转化的快慢”。  \r
   **答案**：必须同时说出物理对象和关系：同一工作状态测U和I后相乘。只重复标题不算完成。\r
2. **条件辨认**：写出P=UI中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C9超额定过多”。\r
3. **图示应用**：请画一张“测功率电路图”，用图解释“同一工作状态测U和I后相乘”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：额定2.5 V时0.3 A，额定功率。  \r
   **答案**：0.75 W。关键模型：同一工作状态测U和I后相乘。\r
5. **情境与错因侦探**：同学完成“调变阻器使灯泡在低于、等于、略高额定电压下工作”后出现“C4把实际与额定混用”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4把实际与额定混用**。先检查与“同一工作状态测U和I后相乘”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电热与电流平方、电阻、时间有关”。  \r
   **答案**：必须同时说出物理对象和关系：控制变量比较电阻丝产热。只重复标题不算完成。\r
2. **条件辨认**：写出Q=I²Rt中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4串并联时没辨相同量”。\r
3. **图示应用**：请画一张“串联电热对比图”，用图解释“控制变量比较电阻丝产热”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：电流变2倍，其他不变，电热变几倍。  \r
   **答案**：4倍。关键模型：控制变量比较电阻丝产热。\r
5. **情境与错因侦探**：同学完成“串联两不同电阻丝，用相同电流比较温升”后出现“C5漏平方”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C5漏平方**。先检查与“控制变量比较电阻丝产热”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“家庭电路并联，保护装置切断危险通路”。  \r
   **答案**：必须同时说出物理对象和关系：火线—用电器—零线与接地保护。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“火线—用电器—零线与接地保护”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C8湿手操作”。\r
3. **图示应用**：请画一张“家庭电路安全图”，用图解释“火线—用电器—零线与接地保护”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：多个大功率电器同插座有何风险。  \r
   **答案**：总电流过大导致导线过热和火灾风险。关键模型：火线—用电器—零线与接地保护。\r
5. **情境与错因侦探**：同学完成“识别三孔插座、总开关和漏电保护器，不接触市电”后出现“C3开关接零线”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3开关接零线**。先检查与“火线—用电器—零线与接地保护”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“磁场对放入其中的磁体有力作用”。  \r
   **答案**：必须同时说出物理对象和关系：小磁针N极受力方向定义场方向。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“小磁针N极受力方向定义场方向”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3方向画反”。\r
3. **图示应用**：请画一张“条形磁体场线图”，用图解释“小磁针N极受力方向定义场方向”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：条形磁体外部磁感线方向。  \r
   **答案**：从N极到S极。关键模型：小磁针N极受力方向定义场方向。\r
5. **情境与错因侦探**：同学完成“磁体周围放多枚小磁针并标N极方向”后出现“C1把磁感线当真实线”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C1把磁感线当真实线**。先检查与“小磁针N极受力方向定义场方向”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电流周围有磁场，螺线管外部像条形磁体”。  \r
   **答案**：必须同时说出物理对象和关系：电流方向决定磁场方向。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“电流方向决定磁场方向”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C4只改电池位置不记录”。\r
3. **图示应用**：请画一张“螺线管小磁针图”，用图解释“电流方向决定磁场方向”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：电流反向后磁极怎样。  \r
   **答案**：N、S极对调。关键模型：电流方向决定磁场方向。\r
5. **情境与错因侦探**：同学完成“改变电流方向，记录两端小磁针N极指向”后出现“C3电流方向与场方向混淆”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C3电流方向与场方向混淆**。先检查与“电流方向决定磁场方向”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“通电导线在磁场中受力”。  \r
   **答案**：必须同时说出物理对象和关系：电能→机械能；电流或磁场反向则受力反向。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“电能→机械能；电流或磁场反向则受力反向”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C3只反一项却判方向不变”。\r
3. **图示应用**：请画一张“电动机受力图”，用图解释“电能→机械能；电流或磁场反向则受力反向”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：电动机主要把什么能转为什么能。  \r
   **答案**：电能转化为机械能。关键模型：电能→机械能；电流或磁场反向则受力反向。\r
5. **情境与错因侦探**：同学完成“让通电线框在磁场中运动并分别反向电流、磁场”后出现“C2与发电机混淆”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C2与发电机混淆**。先检查与“电能→机械能；电流或磁场反向则受力反向”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“闭合电路一部分导体切割磁感线可产生感应电流”。  \r
   **答案**：必须同时说出物理对象和关系：机械运动—磁场变化—电能。只重复标题不算完成。\r
2. **条件辨认**：不用公式，只用“机械运动—磁场变化—电能”判断并说明条件。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C2与电动机能量链混淆”。\r
3. **图示应用**：请画一张“切割磁感线图”，用图解释“机械运动—磁场变化—电能”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：导体静止在磁场中是否有感应电流。  \r
   **答案**：没有；还需闭合且切割磁感线。关键模型：机械运动—磁场变化—电能。\r
5. **情境与错因侦探**：同学完成“改变导体运动方向、磁场方向与是否闭合，观察灵敏电流计”后出现“C4漏闭合条件”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4漏闭合条件**。先检查与“机械运动—磁场变化—电能”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
...
## 10分钟练习\r
\r
1. **概念判断**：用自己的话解释“电磁波传信息，能源选择需看来源、效率、安全和环境”。  \r
   **答案**：必须同时说出物理对象和关系：需求—证据—约束—方案—评价。只重复标题不算完成。\r
2. **条件辨认**：写出v=λf中各量对应的对象，并说一个不能直接使用它的情形。  \r
   **答案**：对象、过程和状态要配对；本课特别要防止“C1可再生等同无影响”。\r
3. **图示应用**：请画一张“方案评价矩阵”，用图解释“需求—证据—约束—方案—评价”。  \r
   **答案**：至少标出研究对象、关键方向/变量和适用边界；图与文字结论必须一致。\r
4. **基础应用**：波速3×10^8 m/s、频率10^8 Hz，波长。  \r
   **答案**：3 m；方案还需评价稳定性与环境影响。关键模型：需求—证据—约束—方案—评价。\r
5. **情境与错因侦探**：同学完成“为“节能小屋”在太阳能、风能和市电间做证据化选择”后出现“C4只看单一指标”。这属于哪类错误，下一步先检查什么？  \r
   **答案**：归入 **C4只看单一指标**。先检查与“需求—证据—约束—方案—评价”直接相关的对象和条件，再决定重画图、重读数或重算。\r
\r
## 为什么错\r
\r
