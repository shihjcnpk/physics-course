...
math_connection: 本课数学只服务于物理问题“怎样把“差不多”变成可比较的数据？”。小数：准确记录和比较测量值；单位换算：让同类量在计算前使用统一单位。\r
...
## 开课前｜数学准备\r
\r
数学前置：小数、单位换算。本课数学只服务于物理问题“怎样把“差不多”变成可比较的数据？”。小数：准确记录和比较测量值；单位换算：让同类量在计算前使用统一单位。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习小数、单位换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：测书本宽度并测30次脉搏时间。\r
\r
## 先猜并设计\r
\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 小京用分度值为1 mm的刻度尺测书宽，记录为18.6，但没有写单位。这个结果是否完整？\r
\r
   **答案**：不完整。测量值必须由数值和单位共同组成，应按实际读数补写单位。\r
2. **[基础·读数/计算]** 尺上12.30 cm表示精确到毫米并估读一位。\r
\r
   **答案**：12.30 cm；末位是估读。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“刻度尺读数图”：先画刻度尺与被测物体，再标出分度值、起点和末端读数，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：刻度尺与被测物体；比较或变化：分度值、起点和末端读数；结果：读数由准确值和估读值组成；结论：测量结果必须写数值和单位；估读不是随意猜。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量类，无自变量；观察测量：长度和时间读数；关键控制：量程、分度值、视线和起止点；证据记录：原始读数、估读位与单位。\r
5. **[提升·解释论证]** 同一支铅笔测三次得到17.82 cm、17.81 cm、18.92 cm。指出异常数据并说明处理办法。\r
\r
   **答案**：18.92 cm明显偏离，先核查起点、分度值和读数；确认操作错误后重测，不能把异常值直接放入平均值。\r
\r
## 为什么错\r
\r
- **单位错误**：先统一单位，再把数值代入关系式。\r
- **漏读分度值**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
课程起点：从感觉进入可测量的证据。\r
...
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
`,Xn=`---\r
lesson_id: L002\r
title: 运动和静止：先选参照物\r
grade: 八年级\r
...
math_connection: 本课数学只服务于物理问题“同一个人为什么既能说在动，也能说没动？”。坐标与方向：处理本课中的数量或图示。\r
...
## 开课前｜数学准备\r
\r
数学前置：坐标与方向。本课数学只服务于物理问题“同一个人为什么既能说在动，也能说没动？”。坐标与方向：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习坐标与方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：玩具车旁放橡皮，分别以桌面和车为参照观察。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 【2024北京中考第3题改编】火箭升空时，下列判断正确的是：A.相对发射塔静止 B.相对地面运动 C.发射塔相对地面运动 D.运动与参照物无关。\r
\r
   **答案**：B。火箭相对地面的位置随时间改变。\r
2. **[基础·读数/计算]** 坐在行驶列车中的人相对座椅静止、相对站台运动。\r
\r
   **答案**：两种说法都对，关键是参照物不同。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“参照物位置对比图”：先画乘客的位置，再标出分别以座椅和站台为参照，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：乘客的位置；比较或变化：分别以座椅和站台为参照；结果：相对座椅不变，相对站台改变；结论：运动和静止取决于研究对象相对参照物的位置是否改变。\r
4. **[典型·证据与实验]** 完成“玩具车旁放橡皮，分别以桌面和车为参照观察”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“相对参照物比较位置”完成一次清楚比较：先定对象和条件，再记录能支持或否定“机械运动是位置随时间改变”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 并排行驶的两列车中，乘客觉得邻车后退。用两个参照物解释为何不矛盾。\r
\r
   **答案**：以本车为参照，邻车相对位置向后变；以站台为参照，邻车仍可能向前。参照物不同，结论可以不同。\r
\r
## 为什么错\r
\r
- **把运动说成绝对**：回到现象和核心句，用自己的话重新解释一次。\r
- **漏参照物**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“路程和时间都不同，怎样公平比快慢？”。除法：求出每一单位对应多少；比率：公平比较两个量的相对大小；单位换算：让同类量在计算前使用统一单位。\r
...
## 开课前｜数学准备\r
\r
数学前置：除法、比率、单位换算。本课数学只服务于物理问题“路程和时间都不同，怎样公平比快慢？”。除法：求出每一单位对应多少；比率：公平比较两个量的相对大小；单位换算：让同类量在计算前使用统一单位。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习除法、比率、单位换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：比较两辆玩具车不同路程与时间，统一到每1秒。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 甲车10 s行80 m，乙车12 s行90 m。谁更快？不能只写答案，要给出公平比较的数据。\r
\r
   **答案**：甲车8 m/s，乙车7.5 m/s，所以甲更快。\r
2. **[基础·读数/计算]** 60 m用12 s，速度是多少。\r
\r
   **答案**：5 m/s，表示每秒通过5 m。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“路程时间条形图”：先画同一运动物体，再标出每段都取相同的1秒，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：同一运动物体；比较或变化：每段都取相同的1秒；结果：1秒内路程越大，运动越快；结论：速度就是单位时间通过的路程，v=s/t。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“单位时间通过的路程”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** 只知道甲路程更长，能否判定甲更快？写出还需要的证据。\r
\r
   **答案**：不能。还需两车所用时间，或给出相同时间内的路程、相同路程所用时间。\r
\r
## 为什么错\r
\r
- **除法错误**：物理关系不变，只把计算过程单独重算一遍。\r
- **单位错误**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
...
math_connection: 本课数学只服务于物理问题“忽快忽慢时，怎样描述整段运动？”。分数：表示部分与整体或两个量的比；加法：合并同一过程中的各段量；图像：从形状和斜率读变化。\r
...
## 开课前｜数学准备\r
\r
数学前置：分数、加法、图像。本课数学只服务于物理问题“忽快忽慢时，怎样描述整段运动？”。分数：表示部分与整体或两个量的比；加法：合并同一过程中的各段量；图像：从形状和斜率读变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习分数、加法、图像，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：走快10 m再慢走10 m，记录各段和总时间。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 骑行者前600 m用120 s，中途停30 s，后400 m用100 s。求全程平均速度。\r
\r
   **答案**：总路程1000 m，总时间250 s，平均速度4 m/s；停留时间必须计入。\r
2. **[基础·读数/计算]** 前10 m用2 s、后10 m用3 s，整段平均速度。\r
\r
   **答案**：20/5=4 m/s，不能平均两个速度。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“分段时间轴”：先画一段完整行程，再标出把快行、停留和慢行都计入，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：一段完整行程；比较或变化：把快行、停留和慢行都计入；结果：得到总路程和总时间；结论：平均速度必须用总路程除以总时间，不能把各段速度直接平均。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“总路程除以总时间”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** 为什么全程平均速度不能用两段速度的算术平均代替？给出条件说明。\r
\r
   **答案**：各段持续时间通常不同，直接平均等于错误地给各段相同权重；应始终用总路程除以总时间。\r
\r
## 为什么错\r
\r
- **把不同路段的路程和时间配错**：重新圈出“整段”，把总路程和总时间配成一组。\r
- **把两段速度直接相加除以2**：不要平均两段速度；重新计算“总路程÷总时间”。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“怎样用证据判断小车在哪一段更快？”。小数：准确记录和比较测量值；单位换算：让同类量在计算前使用统一单位；表格：配对记录同一条件下的数据。\r
...
## 开课前｜数学准备\r
\r
数学前置：小数、单位换算、表格。本课数学只服务于物理问题“怎样用证据判断小车在哪一段更快？”。小数：准确记录和比较测量值；单位换算：让同类量在计算前使用统一单位；表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习小数、单位换算、表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：在缓斜面标两段，重复计时并记录数据。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 测斜面小车速度时，甲同学用全程路程配前半程时间。所得速度能代表哪一段？\r
\r
   **答案**：不能代表任何已明确测量的路段；路程和时间必须来自同一段。\r
2. **[基础·读数/计算]** 0.8 m用1.6 s，速度是多少。\r
\r
   **答案**：0.50 m/s；路程和时间必须来自同一段。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“斜面小车测量图”：先画小车在同一段斜面上的运动，再标出配对测同一段的路程和时间，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：小车在同一段斜面上的运动；比较或变化：配对测同一段的路程和时间；结果：各段算出的速度可比较；结论：只有同一路段的s和t配对，才能得到该段速度。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：所选路段；观察测量：通过该段的时间和算得速度；关键控制：同一小车、斜面坡度和释放方式；证据记录：每段路程、至少三次时间及异常值。\r
5. **[提升·解释论证]** 为了判断小车是否越滑越快，应怎样划分路段、记录数据并比较？\r
\r
   **答案**：沿运动方向划分相邻路段，分别配对记录每段路程和时间，计算各段平均速度；后段速度较大才支持越滑越快。\r
\r
## 为什么错\r
\r
- **数据配错**：重读题目，只圈出决定答案的条件，再作答。\r
- **只测一次**：按对象、条件、单位逐项检查一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 【2022北京中考第3题同型】琴弦正在发声。下列说法正确的是：A.琴弦不振动 B.声音可在真空传播 C.可凭音色区分乐器 D.音调相同则响度必相同。\r
\r
   **答案**：C。声音由振动产生，不能在真空传播；音调与响度是不同特性。\r
2. **[基础·读数/计算]** 太空舱外爆炸能否直接听见。\r
\r
   **答案**：不能；真空不能传声。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“振动传播链图”：先画声源、介质和耳朵，再标出让声源振动并改变传播条件，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：声源、介质和耳朵；比较或变化：让声源振动并改变传播条件；结果：介质传递扰动，耳朵接收到声音；结论：声音由振动产生，传播需要介质；真空不能传声。\r
4. **[典型·证据与实验]** 完成“摸喉咙、拨橡皮筋，再用纸杯电话比较”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“声源振动→介质传递→耳接收”完成一次清楚比较：先定对象和条件，再记录能支持或否定“声音由振动产生并需介质传播”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 罩内闹钟随抽气逐渐变小，为什么不能据此直接说‘抽到真空后仍能听见’？\r
\r
   **答案**：装置难达到绝对真空且罩体也可能传声。可靠结论来自声音随空气减少而减弱，再外推真空不能传声。\r
\r
## 为什么错\r
\r
- **把声音当物质**：回到现象和核心句，用自己的话重新解释一次。\r
- **漏介质**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“同一首歌为什么能听出是谁唱的？”。大小比较：用同一标准比较证据；坐标图像：把数据趋势画出来。\r
from_previous: 承接L006《声音从哪里来、怎样传过去》的声音由振动产生并需介质传播。\r
to_next: 为L008《声音怎样传递作用、噪声怎样控制》准备声源—传播—接收三处分析。\r
...
## 开课前｜数学准备\r
\r
数学前置：大小比较、坐标图像。本课数学只服务于物理问题“同一首歌为什么能听出是谁唱的？”。大小比较：用同一标准比较证据；坐标图像：把数据趋势画出来。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习大小比较、坐标图像，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：弹不同长度橡皮筋并改变拨动力度。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 同一根橡皮筋先轻拨、再用力拨，主要改变的是：A.音调 B.响度 C.音色 D.声速。\r
\r
   **答案**：B。用力拨通常增大振幅，因此响度增大。\r
2. **[基础·读数/计算]** 用力拨同一根弦主要改变什么。\r
\r
   **答案**：响度；弦的振动频率近似不变。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“三种波形对比图”：先画声音的波形与听感，再标出分别比较频率、振幅和波形，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：声音的波形与听感；比较或变化：分别比较频率、振幅和波形；结果：对应音调、响度和音色的差别；结论：频率决定音调，振幅影响响度，波形特征反映音色。\r
4. **[典型·证据与实验]** 完成“弹不同长度橡皮筋并改变拨动力度”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“频率管高低、振幅管强弱、音色辨声源”完成一次清楚比较：先定对象和条件，再记录能支持或否定“声音有音调、响度、音色三种特性”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 两列波形频率相同、振幅不同。它们的音调和响度分别怎样比较？\r
\r
   **答案**：频率相同所以音调相同；振幅较大的声音通常响度较大。\r
\r
## 为什么错\r
\r
- **三特性混淆**：回到现象和核心句，用自己的话重新解释一次。\r
- **波形读错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L008《声音怎样传递作用、噪声怎样控制》准备声源—传播—接收三处分析。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
curriculum_standard: [2.3.2]\r
pep_mapping: 八上第2章\r
core_question: 声音从声源到接收处经历什么，怎样在这条链上利用或减弱它？\r
core_concept: 声音可传递信息和能量，噪声可从声源、传播、接收三处控制\r
core_model: 声源—传播—接收三处分析\r
formula: "—"\r
math_prerequisite: [分类]\r
math_connection: 本课数学只服务于物理问题“声音从声源到接收处经历什么，怎样在这条链上利用或减弱它？”。分类：按同一规则区分不同情形。\r
...
---\r
\r
# 第8课：声音怎样传递作用、噪声怎样控制\r
\r
## 今天只学一件事\r
\r
回答：**声音从声源到接收处经历什么，怎样在这条链上利用或减弱它？**\r
\r
## 开课前｜数学准备\r
\r
数学前置：分类。本课数学只服务于物理问题“声音从声源到接收处经历什么，怎样在这条链上利用或减弱它？”。分类：按同一规则区分不同情形。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习分类，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：先用纸杯电话传一句口令，再用软布包住响铃比较声音变化。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 看现象 / 做实验\r
\r
任务：先用纸杯电话传一句口令，再用软布包住响铃比较声音变化。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**声音可传递信息和能量，噪声可从声源、传播、接收三处控制**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 把现象画出来，建立模型\r
\r
画：**声音作用三环节图**。图上只保留对象、关键方向/变量和边界。\r
\r
模型句：**声源—传播—接收三处分析**。\r
\r
## 正式物理知识\r
\r
- 概念：声音可传递信息和能量，噪声可从声源、传播、接收三处控制。\r
- 关系：本课无须背公式，先稳定概念和图。\r
...
## 一句话收束\r
\r
今天记住：**声音可传递信息和能量，噪声可从声源、传播、接收三处控制；声源—传播—接收三处分析。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 道路旁种植密集树木、居民关上双层窗，主要在哪一环节减弱噪声？\r
\r
   **答案**：传播途径。措施没有改变声源，也不是直接保护听者耳朵。\r
2. **[基础·读数/计算]** 给临街房间选降噪措施。\r
\r
   **答案**：关窗主要在传播途径减弱噪声。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“声音作用三环节图”：先画声源—传播途径—接收端，再标出在三处分别采取措施，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：声源—传播途径—接收端；比较或变化：在三处分别采取措施；结果：接收端获得的信息或噪声强弱改变；结论：声音能传信息和能量；控制噪声要先判断作用环节。\r
4. **[典型·证据与实验]** 完成“先用纸杯电话传一句口令，再用软布包住响铃比较声音变化”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“声源—传播—接收三处分析”完成一次清楚比较：先定对象和条件，再记录能支持或否定“声音可传递信息和能量，噪声可从声源、传播、接收三处控制”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 为图书馆邻近施工设计一条降噪建议，并指出作用环节。\r
\r
   **答案**：例如施工设备加隔声罩，作用在声源或刚离开声源处；关闭双层窗则作用在传播途径。\r
\r
## 为什么错\r
\r
- **控制环节混乱**：圈出研究对象和关键条件，再重新选择模型。\r
- **忽略情境**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“手觉得一冷一热，能当作可靠测量吗？”。正负数：区分零点两侧或变化方向；刻度：按分度值正确读数。\r
from_previous: 承接L008《声音怎样传递作用、噪声怎样控制》的声音可传递信息和能量，噪声可从声源、传播、接收三处控制。\r
...
## 开课前｜数学准备\r
\r
数学前置：正负数、刻度。本课数学只服务于物理问题“手觉得一冷一热，能当作可靠测量吗？”。正负数：区分零点两侧或变化方向；刻度：按分度值正确读数。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习正负数、刻度，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：三杯水先用手判断再用温度计测量。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 温度计液柱顶端在0 ℃以下第4小格，每小格1 ℃。俯视读数是否规范？正确示数是多少？\r
\r
   **答案**：不规范，视线应与液柱顶端相平；示数为−4 ℃。\r
2. **[基础·读数/计算]** 温度计示数在0下4格、每格1℃。\r
\r
   **答案**：−4℃；视线与液柱顶端相平。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“温度计读数图”：先画温度计内的测温液体，再标出让温度改变并观察液柱，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：温度计内的测温液体；比较或变化：让温度改变并观察液柱；结果：液柱位置随温度规律变化；结论：温度计把冷热程度转换为可读刻度，读数时视线要与液柱顶端相平。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：被测对象；观察测量：温度计示数；关键控制：温度计量程、浸入位置、稳定等待和视线；证据记录：带正负号与℃的读数。\r
5. **[提升·解释论证]** 手先放冷水再放温水，与先放热水再放温水感受不同，说明测温为什么不能只靠感觉？\r
\r
   **答案**：同一杯温水因手原来的状态不同而感觉不同，感觉受比较基准影响；应使用温度计获得可比较数据。\r
\r
## 为什么错\r
\r
- **读数方向错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **漏摄氏度**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L008《声音怎样传递作用、噪声怎样控制》的声音可传递信息和能量，噪声可从声源、传播、接收三处控制。\r
\r
## 下一课会发生什么\r
\r
...
math_connection: 本课数学只服务于物理问题“冰、水和水蒸气是三种物质吗？”。箭头：处理本课中的数量或图示；分类：按同一规则区分不同情形。\r
...
## 开课前｜数学准备\r
\r
数学前置：箭头、分类。本课数学只服务于物理问题“冰、水和水蒸气是三种物质吗？”。箭头：处理本课中的数量或图示；分类：按同一规则区分不同情形。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习箭头、分类，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：观察冰融化和杯外水珠，只先标起点与终点。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 冬天眼镜从室外进入暖屋后出现小水珠。它的初态和末态分别是什么？\r
\r
   **答案**：空气中的水蒸气（气态）变成小水滴（液态），属于液化。\r
2. **[基础·读数/计算]** 冰变水属于什么变化。\r
\r
   **答案**：熔化：固态到液态。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“三态六箭头图”：先画同一种物质，再标出改变吸放热条件，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：同一种物质；比较或变化：改变吸放热条件；结果：固、液、气三态互相转化；结论：判断物态变化要先写初态和末态，再按箭头命名。\r
4. **[典型·证据与实验]** 完成“观察冰融化和杯外水珠，只先标起点与终点”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“三态之间六种变化方向”完成一次清楚比较：先定对象和条件，再记录能支持或否定“同种物质可处于固液气三态”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把‘杯外水珠是杯内水渗出’改造成可检验的实验方案。\r
\r
   **答案**：把密封良好的空杯和装冷水杯置于同一环境；若只有冷杯外出现水珠，支持空气中水蒸气遇冷液化。\r
\r
## 为什么错\r
\r
- **把水珠说成杯中渗出**：回到现象和核心句，用自己的话重新解释一次。\r
- **箭头反向**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“冰在熔化时一直吸热，温度会一直升吗？”。坐标图像：把数据趋势画出来；坐标系：表示位置与变化。\r
...
## 开课前｜数学准备\r
\r
数学前置：坐标图像、坐标系。本课数学只服务于物理问题“冰在熔化时一直吸热，温度会一直升吗？”。坐标图像：把数据趋势画出来；坐标系：表示位置与变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习坐标图像、坐标系，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用碎冰和温度计观察，或读取规范实验数据。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 某物质加热图像出现水平平台，平台期固液共存。小京说‘温度不升，所以没有吸热’，是否正确？\r
\r
   **答案**：错误。晶体熔化时继续吸热，但温度保持在熔点。\r
2. **[基础·读数/计算]** 加热晶体的曲线出现温度平台，同时仍有固液两态，说明什么。\r
\r
   **答案**：晶体正在熔化，继续吸热但温度保持在熔点。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“熔化曲线图”：先画晶体熔化过程，再标出持续加热并按时测温，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：晶体熔化过程；比较或变化：持续加热并按时测温；结果：熔化阶段吸热但温度保持不变；结论：晶体有确定熔点；平台段仍在吸热，只是温度不升。\r
4. **[典型·证据与实验]** 完成“用碎冰和温度计观察，或读取规范实验数据”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“晶体熔化时吸热、温度保持在熔点”完成一次清楚比较：先定对象和条件，再记录能支持或否定“晶体在一定条件下有确定熔点”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 根据熔化曲线的平台，怎样判断平台前、平台中、平台后的物态？\r
\r
   **答案**：平台前低于熔点为固态；平台中熔化，通常固液共存；平台后完全熔化为液态并继续升温。\r
\r
## 为什么错\r
\r
- **平台读错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **把不升温当不吸热**：回到现象和核心句，用自己的话重新解释一次。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“水沸腾后继续加热，温度还会升吗？”。表格：配对记录同一条件下的数据；坐标图像：把数据趋势画出来。\r
...
## 开课前｜数学准备\r
\r
数学前置：表格、坐标图像。本课数学只服务于物理问题“水沸腾后继续加热，温度还会升吗？”。表格：配对记录同一条件下的数据；坐标图像：把数据趋势画出来。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习表格、坐标图像，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：按分钟记录温度和气泡，画温度—时间图。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 水沸腾后温度稳定在98 ℃。继续加热时，水是否还吸热？98 ℃说明什么？\r
\r
   **答案**：仍吸热，能量用于汽化；98 ℃是当时条件下的沸点，不能强改成100 ℃。\r
2. **[基础·读数/计算]** 水沸腾后读数保持98℃说明什么。\r
\r
   **答案**：当地条件下沸点约98℃，继续吸热用于汽化。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“沸腾装置与曲线图”：先画正在加热的水，再标出比较沸腾前和沸腾时的温度，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：正在加热的水；比较或变化：比较沸腾前和沸腾时的温度；结果：沸腾时气泡剧烈形成，温度近似不变；结论：液体达到沸点并继续吸热才沸腾；沸腾时温度保持不变。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：加热时间；观察测量：水温和气泡特征；关键控制：水量、容器、热源与温度计位置；证据记录：多组温度—时间数据和沸腾前后现象。\r
5. **[提升·解释论证]** 实验只记录一次沸腾温度就下结论可靠吗？写出至少两项改进。\r
\r
   **答案**：不可靠。应等水充分沸腾后连续多次读数，并重复实验；同时规范温度计位置、读数视线和加热条件。\r
\r
## 为什么错\r
\r
- **图像轴错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **用一次读数下结论**：按对象、条件、单位逐项检查一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“湿衣服的水不沸腾，为什么也会消失？”。大小比较：用同一标准比较证据。\r
...
## 开课前｜数学准备\r
\r
数学前置：大小比较。本课数学只服务于物理问题“湿衣服的水不沸腾，为什么也会消失？”。大小比较：用同一标准比较证据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习大小比较，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：两滴等量水分别摊开与成滴，比较干燥速度。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 冰饮料杯外壁出现水珠。水珠来自杯内渗水还是空气？写出证据方向。\r
\r
   **答案**：来自空气中的水蒸气液化；可用密封不漏水的冷杯仍出现外壁水珠作证据。\r
2. **[基础·读数/计算]** 夏天冰饮料杯外水珠来自哪里。\r
\r
   **答案**：空气中水蒸气液化，不是杯内渗水。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“蒸发条件对比图”：先画液态水与水蒸气，再标出改变温度、表面积或空气流动，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：液态水与水蒸气；比较或变化：改变温度、表面积或空气流动；结果：蒸发快慢变化；水蒸气遇冷成小水滴；结论：汽化吸热，液化放热；白雾是小液滴，不是水蒸气。\r
4. **[典型·证据与实验]** 完成“两滴等量水分别摊开与成滴，比较干燥速度”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“液体↔气体的能量过程”完成一次清楚比较：先定对象和条件，再记录能支持或否定“蒸发可在任何温度发生，液化会放热”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 等量水滴一滴摊开、一滴保持水滴状，如何控制变量并判断蒸发快慢？\r
\r
   **答案**：水量、温度、空气流动和材料相同，只改表面积；比较相同时间剩余水量或完全蒸干时间。\r
\r
## 为什么错\r
\r
- **蒸发等同沸腾**：回到现象和核心句，用自己的话重新解释一次。\r
- **水珠来源错**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 为什么要学它？\r
\r
想一想这个生活场景：观察冷冻室霜或碘升华视频，只追踪物质去向。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 冷冻室内壁的霜不是液态水冻成的。写出形成霜的初态、末态和名称。\r
\r
   **答案**：水蒸气由气态直接变为固态冰晶，属于凝华。\r
2. **[基础·读数/计算]** 窗上冰花通常形成在哪一侧。\r
\r
   **答案**：室内侧；水蒸气遇冷凝华。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“水循环箭头图”：先画水在固态与气态间的变化，再标出比较物质的初态和末态，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：水在固态与气态间的变化；比较或变化：比较物质的初态和末态；结果：可跳过液态直接变化；结论：固态直接变气态叫升华，气态直接变固态叫凝华。\r
4. **[典型·证据与实验]** 完成“观察冷冻室霜或碘升华视频，只追踪物质去向”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“固↔气与水循环状态链”完成一次清楚比较：先定对象和条件，再记录能支持或否定“物质可直接在固态和气态间变化”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 解释人工降雪与窗上冰花时，为什么必须先追踪物质的初态和末态？\r
\r
   **答案**：物态变化名称由初态到末态的路径决定；只看最终是固态，无法区分凝固和凝华。\r
\r
## 为什么错\r
\r
- **状态箭头错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **忽略冷热位置**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“为什么手电筒的光过三个小孔时必须对齐？”。几何直线：表示传播路径；方向：处理本课中的数量或图示。\r
...
## 开课前｜数学准备\r
\r
数学前置：几何直线、方向。本课数学只服务于物理问题“为什么手电筒的光过三个小孔时必须对齐？”。几何直线：表示传播路径；方向：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习几何直线、方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：让手电筒光通过三张带孔纸，移动中间纸。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 三张带孔纸板只有在三个孔和光源大致共线时，末端光屏才见亮点。这支持什么结论？结论有什么条件？\r
\r
   **答案**：支持光沿直线传播；条件是光在同种均匀介质中传播。\r
2. **[基础·读数/计算]** 影子怎样形成。\r
\r
   **答案**：光沿直线传播，物体挡住部分光。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“三孔与影子光路图”：先画光在同一种均匀介质中的路径，再标出移动中间带孔纸板，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：光在同一种均匀介质中的路径；比较或变化：移动中间带孔纸板；结果：三孔共线时光才能通过；结论：光在同种均匀介质中沿直线传播，光线箭头表示传播方向。\r
4. **[典型·证据与实验]** 完成“让手电筒光通过三张带孔纸，移动中间纸”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“用光线表示传播路径”完成一次清楚比较：先定对象和条件，再记录能支持或否定“光在同种均匀介质中沿直线传播”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 日食、影子和小孔成像都能用同一模型解释。写出共同模型和一个适用条件。\r
\r
   **答案**：共同模型是光沿直线传播；适用条件是光在同种均匀介质中传播。\r
\r
## 为什么错\r
\r
- **漏适用条件**：回到现象和核心句，用自己的话重新解释一次。\r
- **光线不画箭头**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“镜子能把光“弹”到哪里？”。几何角：相对法线测量和比较角；垂线：建立法线或力臂。\r
...
## 开课前｜数学准备\r
\r
数学前置：几何角、垂线。本课数学只服务于物理问题“镜子能把光“弹”到哪里？”。几何角：相对法线测量和比较角；垂线：建立法线或力臂。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习几何角、垂线，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用平面镜、纸屏和量角器改变入射角测三组数据。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 入射光线与镜面夹角30°，反射角是多少？小京答30°，错在什么地方？\r
\r
   **答案**：反射角为60°。入射角和反射角都以法线为基准，不以镜面为基准。\r
2. **[基础·读数/计算]** 入射光与镜面夹30°，反射角是多少。\r
\r
   **答案**：60°；入射角和反射角都相对法线测量。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“反射光路图”：先画入射光线、法线和反射光线，再标出改变入射光线相对法线的角度，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：入射光线、法线和反射光线；比较或变化：改变入射光线相对法线的角度；结果：反射光线随之改变且两角相等；结论：反射角等于入射角；角度都从法线量起。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：入射角；观察测量：反射角和光路位置；关键控制：同一镜面、入射点和量角方法；证据记录：不少于三组i与r及翻折光屏现象。\r
5. **[提升·解释论证]** 探究反射规律为什么要改变入射角测多组数据，并让纸板折转？\r
\r
   **答案**：多组角度用于检验反射角始终等于入射角，避免偶然；折转纸板用于检验三线是否在同一平面。\r
\r
## 为什么错\r
\r
- **角相对镜面量**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **由一组数据定律**：按对象、条件、单位逐项检查一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“镜中的像能落在纸屏上吗？”。垂线：建立法线或力臂；对称：定位像与物的位置关系。\r
...
## 开课前｜数学准备\r
\r
数学前置：垂线、对称。本课数学只服务于物理问题“镜中的像能落在纸屏上吗？”。垂线：建立法线或力臂；对称：定位像与物的位置关系。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习垂线、对称，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：玻璃板前后用两支相同蜡烛定位像，再放光屏。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 人站在平面镜前1.2 m处，向镜面靠近0.2 m。此时像到人的距离是多少？\r
\r
   **答案**：物距变为1.0 m，像距也是1.0 m，像到人的距离2.0 m。\r
2. **[基础·读数/计算]** 人离镜1 m，像离人多远。\r
\r
   **答案**：2 m；像在镜后1 m。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“玻璃板成像图”：先画物体、平面镜和像，再标出改变物体到镜面的距离，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：物体、平面镜和像；比较或变化：改变物体到镜面的距离；结果：像距同步改变且始终与物距相等；结论：平面镜成等大正立虚像，像与物关于镜面对称。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：物距；观察测量：像距、像大小和能否承接；关键控制：同一玻璃板、相同物体、测量基准；证据记录：多组物距像距及光屏检验。\r
5. **[提升·解释论证]** 平面镜实验中为何用玻璃板而不用不透明镜子？为何还要两支相同蜡烛？\r
\r
   **答案**：玻璃板既成像又能看到镜后蜡烛，便于定位像；相同蜡烛与像重合可比较像与物的大小。\r
\r
## 为什么错\r
\r
- **把像画成实线光线会聚**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **漏总距离**：物理关系不变，只把计算过程单独重算一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
formula: "—"\r
math_prerequisite: [几何角, 垂线]\r
math_connection: 本课数学只服务于物理问题“水里的筷子为什么像折断了？”。几何角：相对法线测量和比较角；垂线：建立法线或力臂。\r
...
## 开课前｜数学准备\r
\r
数学前置：几何角、垂线。本课数学只服务于物理问题“水里的筷子为什么像折断了？”。几何角：相对法线测量和比较角；垂线：建立法线或力臂。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习几何角、垂线，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：激光斜射入水，观察并画入射与折射路径。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 一束光从空气斜射入水。画图前必须先画哪条辅助线？折射光线相对入射方向怎样偏？\r
\r
   **答案**：先过入射点画法线；从空气斜入水时折射光线向法线偏。\r
2. **[基础·读数/计算]** 从空气斜射入水，光线通常靠近哪条线。\r
\r
   **答案**：法线。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“空气水界面光路图”：先画斜射到界面的光线，再标出让光从一种介质斜射入另一种介质，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：斜射到界面的光线；比较或变化：让光从一种介质斜射入另一种介质；结果：传播方向在界面处改变；结论：光斜入不同介质通常发生折射；从空气斜入水时折向法线。\r
4. **[典型·证据与实验]** 完成“激光斜射入水，观察并画入射与折射路径”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“入射介质—界面—折射光线模型”完成一次清楚比较：先定对象和条件，再记录能支持或否定“光斜入不同介质时传播方向通常改变”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 筷子看起来上折并非筷子真的弯了。按‘光从哪里来—在哪里折射—眼睛怎样反向判断’解释。\r
\r
   **答案**：水中筷子反射的光在水面折射后进入眼睛；眼睛按直线反向判断光源位置，于是看到较浅的虚像。\r
\r
## 为什么错\r
\r
- **法线漏画**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **背方向不看传播介质**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
pep_mapping: 八上第5章\r
core_question: 同一束平行光通过两种透镜后，为什么一束会聚、一束发散？\r
core_concept: 凸透镜会聚、凹透镜发散\r
core_model: 三条特殊光线建立透镜模型\r
formula: "—"\r
math_prerequisite: [几何直线, 对称]\r
math_connection: 本课数学只服务于物理问题“同一束平行光通过两种透镜后，为什么一束会聚、一束发散？”。几何直线：表示传播路径；对称：定位像与物的位置关系。\r
...
## 今天只学一件事\r
\r
回答：**同一束平行光通过两种透镜后，为什么一束会聚、一束发散？**\r
\r
## 开课前｜数学准备\r
\r
数学前置：几何直线、对称。本课数学只服务于物理问题“同一束平行光通过两种透镜后，为什么一束会聚、一束发散？”。几何直线：表示传播路径；对称：定位像与物的位置关系。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习几何直线、对称，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用低亮度手电筒和平行光纸卡观察两类透镜后的光束。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 平行光通过甲透镜后会聚，通过乙透镜后发散。甲、乙分别是什么透镜？\r
\r
   **答案**：甲是凸透镜，乙是凹透镜。判断依据是对光束的作用，不只凭外形厚薄。\r
2. **[基础·读数/计算]** 平行光经凸透镜后经过哪里。\r
\r
   **答案**：焦点。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“凸凹透镜光路图”：先画平行光束与透镜，再标出换用凸透镜或凹透镜，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：平行光束与透镜；比较或变化：换用凸透镜或凹透镜；结果：光束分别会聚或发散；结论：凸透镜使平行光会聚，凹透镜使平行光发散；虚焦点是反向延长线交点。\r
4. **[典型·证据与实验]** 完成“用低亮度手电筒和平行光纸卡观察两类透镜后的光束”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“三条特殊光线建立透镜模型”完成一次清楚比较：先定对象和条件，再记录能支持或否定“凸透镜会聚、凹透镜发散”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 凹透镜后的发散光线反向延长线相交于焦点。为什么这个焦点叫虚焦点？\r
\r
   **答案**：实际光线没有在那里相交，只有反向延长线相交，因此不能在该点用光屏承接亮点。\r
\r
## 为什么错\r
\r
- **凭厚薄认错**：回到现象和核心句，用自己的话重新解释一次。\r
- **折射光线方向错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“物体靠近透镜，像会怎样变？”。不等式：区分不同条件区间；表格：配对记录同一条件下的数据。\r
from_previous: 承接L019《透镜怎样改变光束》的凸透镜会聚、凹透镜发散。\r
to_next: 为L021《凸透镜应用：成像区间怎样选器件》准备成像区间→像的性质→器件功能。\r
...
## 开课前｜数学准备\r
\r
数学前置：不等式、表格。本课数学只服务于物理问题“物体靠近透镜，像会怎样变？”。不等式：区分不同条件区间；表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习不等式、表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：固定焦距，改变物距并在光屏上找清晰像。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 【2023北京中考第24题数据思想】同一凸透镜成实像时，物距由17 cm增至40 cm，像高由2.5 cm减至0.9 cm。数据支持什么趋势？\r
\r
   **答案**：在该实像区间内，物距增大，所成实像高度减小。结论不能外推到所有物距。\r
2. **[基础·读数/计算]** 物距大于2f时像有何特点。\r
\r
   **答案**：倒立、缩小、实像，像在f与2f之间。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“光具座区间图”：先画蜡烛、凸透镜和光屏，再标出改变物距与焦距的关系，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：蜡烛、凸透镜和光屏；比较或变化：改变物距与焦距的关系；结果：像的位置、大小和虚实发生变化；结论：先判断物距所在区间，再判断像的性质；实像可承接，虚像不可。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：物距u；观察测量：像距、大小、正倒和虚实；关键控制：同一凸透镜、同一物体、同一光具座；证据记录：u相对f和2f的多区间记录。\r
5. **[提升·解释论证]** 光屏上找不到像时，不能立刻判定成虚像。列出两项应先排查的操作条件。\r
\r
   **答案**：先检查烛焰、透镜、光屏中心是否等高，再在合理范围移动光屏；还应核对物距是否大于焦距。\r
\r
## 为什么错\r
\r
- **未先比较u与f**：重读题目，只圈出决定答案的条件，再作答。\r
- **找不到像就下结论**：按对象、条件、单位逐项检查一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L021《凸透镜应用：成像区间怎样选器件》准备成像区间→像的性质→器件功能。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
curriculum_standard: [2.3.5]\r
pep_mapping: 八上第5章\r
core_question: 照相机、投影仪、放大镜为什么都用凸透镜，却得到不同的像？\r
core_concept: 物距所在区间决定凸透镜的成像用途\r
core_model: 成像区间→像的性质→器件功能\r
formula: "—"\r
math_prerequisite: [区间, 比例]\r
math_connection: 本课数学只服务于物理问题“照相机、投影仪、放大镜为什么都用凸透镜，却得到不同的像？”。区间：处理本课中的数量或图示；比例：判断两个量是否按固定关系变化。\r
...
---\r
\r
# 第21课：凸透镜应用：成像区间怎样选器件\r
\r
## 今天只学一件事\r
\r
回答：**照相机、投影仪、放大镜为什么都用凸透镜，却得到不同的像？**\r
\r
## 开课前｜数学准备\r
\r
数学前置：区间、比例。本课数学只服务于物理问题“照相机、投影仪、放大镜为什么都用凸透镜，却得到不同的像？”。区间：处理本课中的数量或图示；比例：判断两个量是否按固定关系变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习区间、比例，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：把物体依次放在2f外、f与2f间、f内，判断像能否在纸屏上承接。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 看现象 / 做实验\r
\r
任务：把物体依次放在2f外、f与2f间、f内，判断像能否在纸屏上承接。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**物距所在区间决定凸透镜的成像用途**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 把现象画出来，建立模型\r
\r
画：**三种应用对比图**。图上只保留对象、关键方向/变量和边界。\r
\r
模型句：**成像区间→像的性质→器件功能**。\r
\r
## 正式物理知识\r
\r
- 概念：物距所在区间决定凸透镜的成像用途。\r
- 关系：本课无须背公式，先稳定概念和图。\r
- 本课不用计算公式。模型边界：成像区间→像的性质→器件功能。\r
- 先用图和证据判断，不把一句口诀套到所有情境。\r
\r
**眼睛与光学器件阅读卡（不占本课20分钟）**：眼睛通过改变晶状体形状调节成像；近视眼用凹透镜矫正。望远镜只观察远处非太阳目标，严禁用透镜直视太阳。\r
\r
## 一个典型例题\r
\r
**题目**：哪种应用得到不能落在光屏上的放大像？\r
\r
**六步建模**：对象是谁 → 已知什么 → 求什么 → 画最简图 → 选“成像区间→像的性质→器件功能” → 检查单位和意义。\r
\r
**答案**：放大镜；物体在焦点以内时得到正立、放大的虚像。\r
\r
## 一句话收束\r
\r
今天记住：**物距所在区间决定凸透镜的成像用途；成像区间→像的性质→器件功能。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 照相机、投影仪、放大镜都用凸透镜。哪一种成的像不能落在光屏上？\r
\r
   **答案**：放大镜。物体在焦点以内时成正立、放大的虚像，虚像不能用光屏承接。\r
2. **[基础·读数/计算]** 哪种应用得到不能落在光屏上的放大像。\r
\r
   **答案**：放大镜；物体在焦点以内时得到正立、放大的虚像。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“三种应用对比图”：先画凸透镜成像装置，再标出把物体放在不同物距区间，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：凸透镜成像装置；比较或变化：把物体放在不同物距区间；结果：得到缩小实像、放大实像或放大虚像；结论：照相机、投影仪、放大镜的差别来自物距区间不同。\r
4. **[典型·证据与实验]** 完成“把物体依次放在2f外、f与2f间、f内，判断像能否在纸屏上承接”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“成像区间→像的性质→器件功能”完成一次清楚比较：先定对象和条件，再记录能支持或否定“物距所在区间决定凸透镜的成像用途”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 同一凸透镜既能做照相机模型，也能做放大镜。决定用途的关键条件是什么？\r
\r
   **答案**：关键是物距与焦距的关系。物体在焦点外可成实像供照相或投影；物体在焦点内成正立、放大的虚像供放大观察。\r
\r
## 为什么错\r
\r
- **器件区间混淆**：圈出研究对象和关键条件，再重新选择模型。\r
- **虚像可接屏**：回到现象和核心句，用自己的话重新解释一次。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
formula: "—"\r
math_prerequisite: [小数, 单位换算]\r
math_connection: 本课数学只服务于物理问题“冰化成水后，质量会改变吗？”。小数：准确记录和比较测量值；单位换算：让同类量在计算前使用统一单位。\r
from_previous: 承接L021《凸透镜应用：成像区间怎样选器件》的物距所在区间决定凸透镜的成像用途。\r
...
## 开课前｜数学准备\r
\r
数学前置：小数、单位换算。本课数学只服务于物理问题“冰化成水后，质量会改变吗？”。小数：准确记录和比较测量值；单位换算：让同类量在计算前使用统一单位。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习小数、单位换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：按调平—左物右码—读数测木块和水质量。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 一块冰熔化成水后，形状和状态改变。若没有物质损失，质量怎样变化？\r
\r
   **答案**：质量不变。质量不随物体形状、状态的改变而改变。\r
2. **[基础·读数/计算]** 砝码50 g、游码2.4 g，物体质量。\r
\r
   **答案**：52.4 g。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“天平平衡图”：先画同一个物体，再标出改变形状、状态或位置，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：同一个物体；比较或变化：改变形状、状态或位置；结果：所含物质多少不变，质量不变；结论：质量是物体本身的属性，通常不随形状、状态和位置改变。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量类，无自变量；观察测量：物体质量；关键控制：天平调平、左物右码、夹取砝码和游码归零；证据记录：砝码质量、游码示数和总质量。\r
5. **[提升·解释论证]** 天平测量前游码未归零会造成怎样的影响？应在何时纠正？\r
\r
   **答案**：游码初始示数会被误计入质量，通常使结果偏大；应在放物体前把游码归零并调平。\r
\r
## 为什么错\r
\r
- **千克克换算错**：先统一单位，再把数值代入关系式。\r
- **天平未调平**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L021《凸透镜应用：成像区间怎样选器件》的物距所在区间决定凸透镜的成像用途。\r
\r
## 下一课会发生什么\r
\r
...
math_connection: 本课数学只服务于物理问题“同样大小的铁块和木块为什么轻重不同？”。比：处理本课中的数量或图示；体积：描述物体占据空间的大小；单位换算：让同类量在计算前使用统一单位。\r
from_previous: 承接L022《质量：物体含有多少物质》的质量不随形状、状态、位置轻易改变。\r
to_next: 为L024《核心实验：测固体密度》准备天平测质量、排水测体积、计算密度。\r
...
## 开课前｜数学准备\r
\r
数学前置：比、体积、单位换算。本课数学只服务于物理问题“同样大小的铁块和木块为什么轻重不同？”。比：处理本课中的数量或图示；体积：描述物体占据空间的大小；单位换算：让同类量在计算前使用统一单位。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习比、体积、单位换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：比较等体积水和食用油质量，统一到1 cm³。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 甲、乙两种材料体积都为20 cm³，质量分别为54 g和178 g。哪种材料密度大？\r
\r
   **答案**：甲为2.7 g/cm³，乙为8.9 g/cm³，所以乙密度大。\r
2. **[基础·读数/计算]** 质量178 g、体积20 cm³，密度。\r
\r
   **答案**：8.9 g/cm³。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“等体积质量对比图”：先画同体积的不同物质，再标出比较各自质量，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：同体积的不同物质；比较或变化：比较各自质量；结果：质量较大的物质单位体积质量更大；结论：密度表示单位体积的质量，ρ=m/V；必须比较同种状态下的物质。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“质量—体积比率模型”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** ‘同种物质质量越大，密度越大’为什么错？用公式中的比率关系说明。\r
\r
   **答案**：同种物质状态不变时，质量增大，体积按相同比例增大，m/V保持不变，所以密度不变。\r
\r
## 为什么错\r
\r
- **比值颠倒**：物理关系不变，只把计算过程单独重算一遍。\r
- **密度单位错**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L024《核心实验：测固体密度》准备天平测质量、排水测体积、计算密度。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
core_concept: 测固体密度要配对同一物体的质量和体积\r
core_model: 天平测质量、排水测体积、计算密度\r
formula: "ρ=m/V"\r
math_prerequisite: [体积差, 小数]\r
math_connection: 本课数学只服务于物理问题“不规则石块的体积怎样测？”。体积差：用末读数减初读数得到排开或取用体积；小数：准确记录和比较测量值。\r
from_previous: 承接L023《密度：相同体积为什么轻重不同》的密度是单位体积的质量。\r
to_next: 为L025《核心实验：测液体密度》准备容器与液体总质量−容器质量→液体质量，再除以体积。\r
...
## 开课前｜数学准备\r
\r
数学前置：体积差、小数。本课数学只服务于物理问题“不规则石块的体积怎样测？”。体积差：用末读数减初读数得到排开或取用体积；小数：准确记录和比较测量值。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习体积差、小数，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：测石块质量，再读石块浸没前后的量筒示数。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
\r
- 自变量/主动改变：测量类，无自变量。\r
- 因变量/观察测量：同一固体的质量、体积和密度。\r
- 关键控制与规范：石块完全浸没且不吸水、量筒视线水平、质量体积对应同一物体。\r
- 证据记录：石块质量、初末体积、体积差与密度。\r
- 结论规则：先描述数据共同趋势，再回答问题；异常数据不许静默删除，要复测或说明。\r
\r
\r
安全提示：使用小型、稳定、无尖锐边缘的器材；发现器材异常立即停止。 \`CORE\`实验应在教师或成人指导下完成。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**测固体密度要配对同一物体的质量和体积**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 整理证据，建立模型\r
\r
...
## 一句话收束\r
\r
今天记住：**测固体密度要配对同一物体的质量和体积；天平测质量、排水测体积、计算密度。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 【2023北京中考第21题同型】土豆块质量44 g、体积40 cm³，求密度，并说明两数据为何必须属于同一块土豆。\r
\r
   **答案**：密度1.1 g/cm³。同一对象的质量和体积才构成有意义的比值。\r
2. **[基础·读数/计算]** 石块54 g，水从30到50 mL，密度。\r
\r
   **答案**：2.7 g/cm³。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“量筒排水图”：先画同一块不规则固体，再标出先称质量，再用排水法测体积，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：同一块不规则固体；比较或变化：先称质量，再用排水法测体积；结果：排开水的体积等于浸没固体体积；结论：同一物体的m与V必须配对，再用ρ=m/V计算密度。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量类，无自变量；观察测量：同一固体的质量、体积和密度；关键控制：石块完全浸没且不吸水、量筒视线水平、质量体积对应同一物体；证据记录：石块质量、初末体积、体积差与密度。\r
5. **[提升·解释论证]** 先测体积后取出潮湿石块测质量，会使密度测量偏大还是偏小？说明证据链。\r
\r
   **答案**：石块带水使测得质量偏大，而体积数据不变，ρ=m/V因此偏大。\r
\r
## 为什么错\r
\r
- **质量体积非同一对象**：重读题目，只圈出决定答案的条件，再作答。\r
- **体积差错**：物理关系不变，只把计算过程单独重算一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L025《核心实验：测液体密度》准备容器与液体总质量−容器质量→液体质量，再除以体积。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
big_idea: 质量与密度\r
importance: ★★★\r
curriculum_standard: [1.2.1, 1.2.3, 1.2.4, 1.3.1, 1.3.2, 1.3.3, 1.3.4, 4.1.2]\r
pep_mapping: 八上第6章\r
core_question: 液体不能直接放在天平上，怎样得到同一份液体的质量和体积？\r
core_concept: 测液体密度要用容器质量差得到液体质量，并与量筒体积配对\r
core_model: 容器与液体总质量−容器质量→液体质量，再除以体积\r
formula: "ρ=(m总-m容)/V"\r
math_prerequisite: [减法, 体积差, 小数]\r
math_connection: 本课数学只服务于物理问题“液体不能直接放在天平上，怎样得到同一份液体的质量和体积？”。减法：从总量中扣除容器或初始部分；体积差：用末读数减初读数得到排开或取用体积；小数：准确记录和比较测量值。\r
from_previous: 承接L024《核心实验：测固体密度》的测固体密度要配对同一物体的质量和体积。\r
...
estimated_practice_minutes: 10\r
difficulty: 基础—典型\r
common_errors: [C5忘记减容器质量, C4质量与体积不是同一份液体]\r
...
## 今天只学一件事\r
\r
回答：**液体不能直接放在天平上，怎样得到同一份液体的质量和体积？**\r
\r
## 开课前｜数学准备\r
\r
数学前置：减法、体积差、小数。本课数学只服务于物理问题“液体不能直接放在天平上，怎样得到同一份液体的质量和体积？”。减法：从总量中扣除容器或初始部分；体积差：用末读数减初读数得到排开或取用体积；小数：准确记录和比较测量值。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习减法、体积差、小数，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：先测空烧杯质量，再加入液体测总质量，最后把液体倒入量筒读体积。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 操作与取证\r
\r
任务：先测空烧杯质量，再加入液体测总质量，最后把液体倒入量筒读体积。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
\r
- 自变量/主动改变：测量类，无自变量。\r
- 因变量/观察测量：同一份液体的质量、体积和密度。\r
- 关键控制与规范：天平调平、容器质量正确相减、量筒视线水平并减少残留。\r
- 证据记录：空容器质量、总质量、液体体积与密度。\r
- 结论规则：先描述数据共同趋势，再回答问题；异常数据不许静默删除，要复测或说明。\r
\r
\r
安全提示：使用小型、稳定、无尖锐边缘的器材；发现器材异常立即停止。 \`CORE\`实验应在教师或成人指导下完成。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**测液体密度要用容器质量差得到液体质量，并与量筒体积配对**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 整理证据，建立模型\r
\r
画：**液体密度测量流程图**。图上只保留对象、关键方向/变量和边界。\r
\r
模型句：**容器与液体总质量−容器质量→液体质量，再除以体积**。\r
\r
## 正式物理知识\r
\r
- 概念：测液体密度要用容器质量差得到液体质量，并与量筒体积配对。\r
- 关系：ρ=(m总-m容)/V\r
- 为什么需要：用一个数量关系回答“液体不能直接放在天平上，怎样得到同一份液体的质量和体积？”。\r
- 量与单位：m总和m容用同一质量单位；V是同一份液体的体积。\r
- 怎样变化：先用质量差得到液体质量，再除以体积。\r
- 适用边界：质量差与量筒体积必须对应同一份液体；倒液残留会带来误差。\r
\r
**材料与尺度阅读卡（不占本课20分钟）**：材料选择要把使用条件与导热、强度、安全等属性配对；再用数量级轴从宇宙—地球—人—细胞—分子—原子—原子核排序。这里只建立材料证据和尺度感，不增加计算。\r
\r
## 一个典型例题\r
\r
**题目**：空杯40 g，杯和液体共94 g，液体体积60 cm³，密度？\r
\r
**六步建模**：对象是谁 → 已知什么 → 求什么 → 画最简图 → 选“容器与液体总质量−容器质量→液体质量，再除以体积” → 检查单位和意义。\r
\r
**答案**：0.90 g/cm³。\r
\r
## 一句话收束\r
\r
今天记住：**测液体密度要用容器质量差得到液体质量，并与量筒体积配对；容器与液体总质量−容器质量→液体质量，再除以体积。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 测液体密度时，小京把烧杯和液体的总质量94 g直接除以液体体积60 cm³。这样做对吗？\r
\r
   **答案**：不对。94 g中包含烧杯质量，必须先减去空烧杯质量，再用液体质量除以同一份液体的体积。\r
2. **[基础·读数/计算]** 空杯40 g，杯和液体共94 g，液体体积60 cm³，密度。\r
\r
   **答案**：0.90 g/cm³。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 画“液体密度测量流程图”：先画同一份液体、容器和量筒，再标出先减去容器质量，再读取对应液体体积，最后在图旁写出看到的结果。\r
\r
   **答案**：图中对象：同一份液体、容器和量筒；比较或变化：先减去容器质量，再读取对应液体体积；结果：得到液体质量和体积这一对数据；结论：用ρ=(m总-m容)/V计算液体密度，质量和体积必须对应同一份液体。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量类，无自变量；观察测量：同一份液体的质量、体积和密度；关键控制：天平调平、容器质量正确相减、量筒视线水平并减少残留；证据记录：空容器质量、总质量、液体体积与密度。\r
5. **[提升·解释论证]** 若先量出60 cm³液体，再把液体倒入烧杯称质量，量筒中有少量液体残留，测得密度偏大还是偏小？\r
\r
   **答案**：倒入烧杯的液体质量对应的实际体积小于记录的60 cm³，却仍用60 cm³作分母，因此测得密度偏小。\r
\r
## 为什么错\r
\r
- **忘记减容器质量**：物理关系不变，只把计算过程单独重算一遍。\r
- **质量与体积不是同一份液体**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L024《核心实验：测固体密度》的测固体密度要配对同一物体的质量和体积。\r
\r
## 下一课会发生什么\r
\r
...
math_connection: 本课数学只服务于物理问题“手推墙时，为什么手也会疼？”。方向：处理本课中的数量或图示；箭头：处理本课中的数量或图示。\r
from_previous: 承接L025《核心实验：测液体密度》的测液体密度要用容器质量差得到液体质量，并与量筒体积配对。\r
...
## 开课前｜数学准备\r
\r
数学前置：方向、箭头。本课数学只服务于物理问题“手推墙时，为什么手也会疼？”。方向：处理本课中的数量或图示；箭头：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习方向、箭头，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：挤气球、推墙，分别说出施力物和受力物。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“漏相互作用”。任务：挤气球、推墙，分别说出施力物和受力物。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“施力物—受力物成对分析”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 脚踢球时谁受力。\r
\r
   **答案**：球受脚的力，脚也受球的力。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“相互作用对象图”，标出研究对象、关键方向或变量，并用图得出“施力物—受力物成对分析”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“挤气球、推墙，分别说出施力物和受力物”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“施力物—受力物成对分析”完成一次清楚比较：先定对象和条件，再记录能支持或否定“力是物体对物体的作用”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：手推墙时，为什么手也会疼？\r
\r
   **答案**：先圈定对象和条件，再用“施力物—受力物成对分析”连接证据与结论。如果出现“只说“有力”不说对象”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **只说“有力”不说对象**：回到现象和核心句，用自己的话重新解释一次。\r
- **漏相互作用**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L025《核心实验：测液体密度》的测液体密度要用容器质量差得到液体质量，并与量筒体积配对。\r
\r
## 下一课会发生什么\r
\r
...
math_connection: 本课数学只服务于物理问题“同样大小的力，为什么推门位置不同效果不同？”。比例：判断两个量是否按固定关系变化；方向：处理本课中的数量或图示。\r
...
## 开课前｜数学准备\r
\r
数学前置：比例、方向。本课数学只服务于物理问题“同样大小的力，为什么推门位置不同效果不同？”。比例：判断两个量是否按固定关系变化；方向：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习比例、方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：在门上不同位置推，画出作用点和方向。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“漏力值单位”。任务：在门上不同位置推，画出作用点和方向。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“用带比例或标值箭头表示力”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 画水平向右5 N的推力。\r
\r
   **答案**：箭头起于作用点、向右并标F=5 N。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“规范力箭头图”，标出研究对象、关键方向或变量，并用图得出“用带比例或标值箭头表示力”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“用带比例或标值箭头表示力”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：同样大小的力，为什么推门位置不同效果不同？\r
\r
   **答案**：先圈定对象和条件，再用“用带比例或标值箭头表示力”连接证据与结论。如果出现“箭头起点错”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **箭头起点错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **漏力值单位**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“站在斜坡上，重力会沿斜坡向下吗？”。乘法：由单位量和份数求总量；比例：判断两个量是否按固定关系变化。\r
...
## 开课前｜数学准备\r
\r
数学前置：乘法、比例。本课数学只服务于物理问题“站在斜坡上，重力会沿斜坡向下吗？”。乘法：由单位量和份数求总量；比例：判断两个量是否按固定关系变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习乘法、比例，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：悬挂小重物观察重垂线，再在斜面图画重力。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“质量单位未化kg”。任务：悬挂小重物观察重垂线，再在斜面图画重力。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“重心处竖直向下”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 2 kg物体重力约多少，取g=10 N/kg。\r
\r
   **答案**：20 N，方向竖直向下。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“斜面重力图”，标出研究对象、关键方向或变量，并用图得出“重心处竖直向下”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“悬挂小重物观察重垂线，再在斜面图画重力”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“重心处竖直向下”完成一次清楚比较：先定对象和条件，再记录能支持或否定“重力是地球对物体的吸引”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：站在斜坡上，重力会沿斜坡向下吗？\r
\r
   **答案**：先圈定对象和条件，再用“重心处竖直向下”连接证据与结论。如果出现“把竖直当垂直斜面”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把竖直当垂直斜面**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **质量单位未化kg**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“拉得越长，弹簧的拉力一定越大吗？”。刻度：按分度值正确读数；比例：判断两个量是否按固定关系变化。\r
...
## 开课前｜数学准备\r
\r
数学前置：刻度、比例。本课数学只服务于物理问题“拉得越长，弹簧的拉力一定越大吗？”。刻度：按分度值正确读数；比例：判断两个量是否按固定关系变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习刻度、比例，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：检查零点、量程、分度值，体验并测量1 N与书的重力。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“超过量程仍使用”。任务：检查零点、量程、分度值，体验并测量1 N与书的重力。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“在限度内形变量反映力大小”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 测力计每大格1 N分5小格，指3小格。\r
\r
   **答案**：0.6 N。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“测力计读数图”，标出研究对象、关键方向或变量，并用图得出“在限度内形变量反映力大小”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量类，无自变量；观察测量：力的示数；关键控制：校零、量程、分度值和受力方向；证据记录：原始示数、单位及是否超量程。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：拉得越长，弹簧的拉力一定越大吗？\r
\r
   **答案**：先圈定对象和条件，再用“在限度内形变量反映力大小”连接证据与结论。如果出现“未校零”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **未校零**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
- **超过量程仍使用**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“给箱子加重和铺毛巾，哪种更难拉？”。表格：配对记录同一条件下的数据。\r
...
## 开课前｜数学准备\r
\r
数学前置：表格。本课数学只服务于物理问题“给箱子加重和铺毛巾，哪种更难拉？”。表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：只改变压力或粗糙程度，匀速拉木块记录力。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“同时改两个变量”。任务：只改变压力或粗糙程度，匀速拉木块记录力。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“水平匀速时拉力等于摩擦力”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 研究粗糙程度时什么必须相同。\r
\r
   **答案**：压力等条件相同。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“水平匀速测摩擦图”，标出研究对象、关键方向或变量，并用图得出“水平匀速时拉力等于摩擦力”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：压力或接触面粗糙程度，每次只改一个；观察测量：水平匀速时的拉力示数；关键控制：速度状态、接触面积处理和其余因素；证据记录：每个条件多次拉力及平均/代表值。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：给箱子加重和铺毛巾，哪种更难拉？\r
\r
   **答案**：先圈定对象和条件，再用“水平匀速时拉力等于摩擦力”连接证据与结论。如果出现“未利用平衡间接测量”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **未利用平衡间接测量**：圈出研究对象和关键条件，再重新选择模型。\r
- **同时改两个变量**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“小车不推为什么会停，真是“不受力就停”吗？”。逻辑推理：从证据逐步推出结论；图像趋势：判断一个量增大时另一个量怎样变。\r
from_previous: 承接L030《核心实验：滑动摩擦力受什么影响》的滑动摩擦与压力和接触面粗糙程度有关。\r
to_next: 为L032《惯性：物体保持原状态的性质》准备刹车前后分别比较人和车状态。\r
...
## 开课前｜数学准备\r
\r
数学前置：逻辑推理、图像趋势。本课数学只服务于物理问题“小车不推为什么会停，真是“不受力就停”吗？”。逻辑推理：从证据逐步推出结论；图像趋势：判断一个量增大时另一个量怎样变。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习逻辑推理、图像趋势，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：比较毛巾、木板、玻璃面上小车滑行距离并外推。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“实验结论直接等同无阻力”。任务：比较毛巾、木板、玻璃面上小车滑行距离并外推。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“阻力逐渐减小→运动保持更久→理想无阻力”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 运动物体不受力将怎样。\r
\r
   **答案**：保持匀速直线运动。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“斜面小车推理图”，标出研究对象、关键方向或变量，并用图得出“阻力逐渐减小→运动保持更久→理想无阻力”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“比较毛巾、木板、玻璃面上小车滑行距离并外推”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“阻力逐渐减小→运动保持更久→理想无阻力”完成一次清楚比较：先定对象和条件，再记录能支持或否定“力不是维持运动的原因”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：小车不推为什么会停，真是“不受力就停”吗？\r
\r
   **答案**：先圈定对象和条件，再用“阻力逐渐减小→运动保持更久→理想无阻力”连接证据与结论。如果出现“把力当维持运动”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把力当维持运动**：回到现象和核心句，用自己的话重新解释一次。\r
- **实验结论直接等同无阻力**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L032《惯性：物体保持原状态的性质》准备刹车前后分别比较人和车状态。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
formula: "—"\r
math_prerequisite: [大小比较]\r
math_connection: 本课数学只服务于物理问题“公交车急刹车，人为什么向前倾？”。大小比较：用同一标准比较证据。\r
...
## 开课前｜数学准备\r
\r
数学前置：大小比较。本课数学只服务于物理问题“公交车急刹车，人为什么向前倾？”。大小比较：用同一标准比较证据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习大小比较，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：抽走纸片观察硬币落杯，再口述前后状态。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“漏原状态”。任务：抽走纸片观察硬币落杯，再口述前后状态。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“刹车前后分别比较人和车状态”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 跳远助跑为什么有用。\r
\r
   **答案**：起跳后身体因惯性保持较大向前速度。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“刹车状态时间轴”，标出研究对象、关键方向或变量，并用图得出“刹车前后分别比较人和车状态”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“抽走纸片观察硬币落杯，再口述前后状态”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“刹车前后分别比较人和车状态”完成一次清楚比较：先定对象和条件，再记录能支持或否定“一切物体都有保持原运动状态的性质”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：公交车急刹车，人为什么向前倾？\r
\r
   **答案**：先圈定对象和条件，再用“刹车前后分别比较人和车状态”连接证据与结论。如果出现“说“受到惯性力””，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **说“受到惯性力”**：回到现象和核心句，用自己的话重新解释一次。\r
- **漏原状态**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“两个方向相同或相反的力一起作用，总效果怎样判断？”。加法：合并同一过程中的各段量；减法：从总量中扣除容器或初始部分；方向：处理本课中的数量或图示。\r
from_previous: 承接L032《惯性：物体保持原状态的性质》的一切物体都有保持原运动状态的性质。\r
...
## 开课前｜数学准备\r
\r
数学前置：加法、减法、方向。本课数学只服务于物理问题“两个方向相同或相反的力一起作用，总效果怎样判断？”。加法：合并同一过程中的各段量；减法：从总量中扣除容器或初始部分；方向：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习加法、减法、方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用两端钩码拉卡片，先比较同向与反向合力，再让反向二力等大观察平衡。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“反向相减后漏合力方向”。任务：用两端钩码拉卡片，先比较同向与反向合力，再让反向二力等大观察平衡。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 物体受向右6 N和向左4 N的力，合力怎样。\r
\r
   **答案**：合力为2 N，方向向右；若两力等大反向且作用在同一物体同一直线上，合力才为零。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“同一直线二力合成与平衡图”，标出研究对象、关键方向或变量，并用图得出“先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“用两端钩码拉卡片，先比较同向与反向合力，再让反向二力等大观察平衡”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线”完成一次清楚比较：先定对象和条件，再记录能支持或否定“同一直线上同向二力相加、反向二力相减；合力为零是二力平衡的特殊情况”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：两个方向相同或相反的力一起作用，总效果怎样判断？\r
\r
   **答案**：先圈定对象和条件，再用“先定正方向；同向相加、反向相减；合力为零时检查同体等大反向共线”连接证据与结论。如果出现“把相互作用力当平衡力”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把相互作用力当平衡力**：圈出研究对象和关键条件，再重新选择模型。\r
- **反向相减后漏合力方向**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L032《惯性：物体保持原状态的性质》的一切物体都有保持原运动状态的性质。\r
\r
## 下一课会发生什么\r
\r
...
math_connection: 本课数学只服务于物理问题“书包带为什么要做宽？”。面积：比较力分布在多大范围；除法：求出每一单位对应多少；单位换算：让同类量在计算前使用统一单位。\r
...
## 开课前｜数学准备\r
\r
数学前置：面积、除法、单位换算。本课数学只服务于物理问题“书包带为什么要做宽？”。面积：比较力分布在多大范围；除法：求出每一单位对应多少；单位换算：让同类量在计算前使用统一单位。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习面积、除法、单位换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：同一块橡皮分别平放和竖放在海绵上。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“只看压力”。任务：同一块橡皮分别平放和竖放在海绵上。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“压力与受力面积共同决定效果”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 600 N站在0.04 m²地面，压强。\r
\r
   **答案**：15000 Pa。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“压力面积对比图”，标出研究对象、关键方向或变量，并用图得出“压力与受力面积共同决定效果”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“同一块橡皮分别平放和竖放在海绵上”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“压力与受力面积共同决定效果”完成一次清楚比较：先定对象和条件，再记录能支持或否定“压强表示单位面积承受的压力”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：书包带为什么要做宽？\r
\r
   **答案**：先圈定对象和条件，再用“压力与受力面积共同决定效果”连接证据与结论。如果出现“面积换算错”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **面积换算错**：物理关系不变，只把计算过程单独重算一遍。\r
- **只看压力**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“潜水越深，耳朵为什么越不舒服？”。表格：配对记录同一条件下的数据；位置与距离：从统一起点判断深浅和间隔。\r
...
## 开课前｜数学准备\r
\r
数学前置：表格、位置与距离。本课数学只服务于物理问题“潜水越深，耳朵为什么越不舒服？”。表格：配对记录同一条件下的数据；位置与距离：从统一起点判断深浅和间隔。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习表格、位置与距离，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：改变探头深度、方向和液体种类，观察U形管高度差。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“一次数据下结论”。任务：改变探头深度、方向和液体种类，观察U形管高度差。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“同种液体压强随深度增加；同深度看密度”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 研究深度影响时保持什么相同。\r
\r
   **答案**：液体种类和探头方向等相同。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“压强计深度图”，标出研究对象、关键方向或变量，并用图得出“同种液体压强随深度增加；同深度看密度”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：深度、方向或液体密度，每轮只改一个；观察测量：U形管液面高度差；关键控制：同一探头、零点和其余条件；证据记录：条件表与稳定后的高度差。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：潜水越深，耳朵为什么越不舒服？\r
\r
   **答案**：先圈定对象和条件，再用“同种液体压强随深度增加；同深度看密度”连接证据与结论。如果出现“把离容器底距离当深度”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把离容器底距离当深度**：重读题目，只圈出决定答案的条件，再作答。\r
- **一次数据下结论**：按对象、条件、单位逐项检查一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“吸盘为什么能贴在墙上？”。面积：比较力分布在多大范围；估算：先判断结果数量级是否合理。\r
...
## 开课前｜数学准备\r
\r
数学前置：面积、估算。本课数学只服务于物理问题“吸盘为什么能贴在墙上？”。面积：比较力分布在多大范围；估算：先判断结果数量级是否合理。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习面积、估算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用装水杯和纸片倒置，观察纸片不落。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“漏压强差”。任务：用装水杯和纸片倒置，观察纸片不落。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“内外压强差产生效果”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 吸管吸饮料是谁把液体压上来。\r
\r
   **答案**：大气压把液体压入低压的吸管。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“吸盘压强差图”，标出研究对象、关键方向或变量，并用图得出“内外压强差产生效果”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“用装水杯和纸片倒置，观察纸片不落”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“内外压强差产生效果”完成一次清楚比较：先定对象和条件，再记录能支持或否定“大气有压强且向各方向作用”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：吸盘为什么能贴在墙上？\r
\r
   **答案**：先圈定对象和条件，再用“内外压强差产生效果”连接证据与结论。如果出现“说嘴把水“吸上来””，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **说嘴把水“吸上来”**：回到现象和核心句，用自己的话重新解释一次。\r
- **漏压强差**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“两张纸中间吹气，为什么纸反而靠近？”。大小比较：用同一标准比较证据；箭头：处理本课中的数量或图示。\r
...
## 开课前｜数学准备\r
\r
数学前置：大小比较、箭头。本课数学只服务于物理问题“两张纸中间吹气，为什么纸反而靠近？”。大小比较：用同一标准比较证据；箭头：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习大小比较、箭头，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：平行悬挂两纸条，从中间吹气并预测。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“压强箭头反”。任务：平行悬挂两纸条，从中间吹气并预测。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“两侧流速差→压强差→受力”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 火车站安全线为什么要退后。\r
\r
   **答案**：列车旁空气流速较大、压强较小，外侧压强可能把人推近。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“机翼流线图”，标出研究对象、关键方向或变量，并用图得出“两侧流速差→压强差→受力”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“平行悬挂两纸条，从中间吹气并预测”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“两侧流速差→压强差→受力”完成一次清楚比较：先定对象和条件，再记录能支持或否定“在常见稳定流动比较中，流速较大处压强较小”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：两张纸中间吹气，为什么纸反而靠近？\r
\r
   **答案**：先圈定对象和条件，再用“两侧流速差→压强差→受力”连接证据与结论。如果出现“说气流把纸吹开”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **说气流把纸吹开**：回到现象和核心句，用自己的话重新解释一次。\r
- **压强箭头反**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“铁块在水里为什么“变轻”？”。减法：从总量中扣除容器或初始部分。\r
...
## 开课前｜数学准备\r
\r
数学前置：减法。本课数学只服务于物理问题“铁块在水里为什么“变轻”？”。减法：从总量中扣除容器或初始部分。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习减法，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：先在空气再浸水读取测力计，比较示数。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“漏竖直向上”。任务：先在空气再浸水读取测力计，比较示数。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“弹簧测力计示数差测浮力”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 空气5 N、水中3 N，浮力。\r
\r
   **答案**：2 N。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“称重法受力图”，标出研究对象、关键方向或变量，并用图得出“弹簧测力计示数差测浮力”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“先在空气再浸水读取测力计，比较示数”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“弹簧测力计示数差测浮力”完成一次清楚比较：先定对象和条件，再记录能支持或否定“浮力是流体对浸入物体向上的作用”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：铁块在水里为什么“变轻”？\r
\r
   **答案**：先圈定对象和条件，再用“弹簧测力计示数差测浮力”连接证据与结论。如果出现“把示数当浮力”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把示数当浮力**：圈出研究对象和关键条件，再重新选择模型。\r
- **漏竖直向上**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
formula: "F浮=G-F示"\r
math_prerequisite: [表格]\r
math_connection: 本课数学只服务于物理问题“物体浸得更深，浮力一定更大吗？”。表格：配对记录同一条件下的数据。\r
...
## 开课前｜数学准备\r
\r
数学前置：表格。本课数学只服务于物理问题“物体浸得更深，浮力一定更大吗？”。表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：改变浸入体积、液体种类；完全浸没后再改深度。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“触底数据仍采用”。任务：改变浸入体积、液体种类；完全浸没后再改深度。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“控制变量比较称重差”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 完全浸没后继续下沉，浮力通常怎样。\r
\r
   **答案**：若液体密度不变且未触底，浮力不变。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“浸入体积对比图”，标出研究对象、关键方向或变量，并用图得出“控制变量比较称重差”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：排开体积或液体密度，每轮只改一个；观察测量：称重差得到的浮力；关键控制：物体不触底、同一物体和测力计状态；证据记录：空气示数、液中示数与浮力。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：物体浸得更深，浮力一定更大吗？\r
\r
   **答案**：先圈定对象和条件，再用“控制变量比较称重差”连接证据与结论。如果出现“把深度与排开体积混淆”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把深度与排开体积混淆**：重读题目，只圈出决定答案的条件，再作答。\r
- **触底数据仍采用**：按对象、条件、单位逐项检查一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“溢出的水和物体受到的浮力有什么关系？”。体积：描述物体占据空间的大小；乘法：由单位量和份数求总量；比例：判断两个量是否按固定关系变化。\r
...
## 开课前｜数学准备\r
\r
数学前置：体积、乘法、比例。本课数学只服务于物理问题“溢出的水和物体受到的浮力有什么关系？”。体积：描述物体占据空间的大小；乘法：由单位量和份数求总量；比例：判断两个量是否按固定关系变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习体积、乘法、比例，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用溢水杯收集排水并比较其重与浮力。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“用物体总体积代排液体积”。任务：用溢水杯收集排水并比较其重与浮力。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“排液质量→排液重力→浮力”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 排开0.2 kg水，取g=10，浮力。\r
\r
   **答案**：2 N。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“溢水杯证据链图”，标出研究对象、关键方向或变量，并用图得出“排液质量→排液重力→浮力”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“用溢水杯收集排水并比较其重与浮力”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“排液质量→排液重力→浮力”完成一次清楚比较：先定对象和条件，再记录能支持或否定“浮力等于排开流体所受重力”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：溢出的水和物体受到的浮力有什么关系？\r
\r
   **答案**：先圈定对象和条件，再用“排液质量→排液重力→浮力”连接证据与结论。如果出现“密度单位错”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **密度单位错**：先统一单位，再把数值代入关系式。\r
- **用物体总体积代排液体积**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“钢铁会沉，钢船为什么能浮？”。不等式：区分不同条件区间。\r
...
## 开课前｜数学准备\r
\r
数学前置：不等式。本课数学只服务于物理问题“钢铁会沉，钢船为什么能浮？”。不等式：区分不同条件区间。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习不等式，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：橡皮泥先团成球再捏成船形放水中。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“浮沉力箭头错”。任务：橡皮泥先团成球再捏成船形放水中。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“F浮与G比较；漂浮时相等”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 漂浮物质量增大后排水怎样变。\r
\r
   **答案**：在仍能漂浮且液体不变时，会排开更多水，直到浮力重新等于重力。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“浮沉三状态图”，标出研究对象、关键方向或变量，并用图得出“F浮与G比较；漂浮时相等”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“橡皮泥先团成球再捏成船形放水中”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“F浮与G比较；漂浮时相等”完成一次清楚比较：先定对象和条件，再记录能支持或否定“浮沉取决于竖直方向浮力和重力关系”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：钢铁会沉，钢船为什么能浮？\r
\r
   **答案**：先圈定对象和条件，再用“F浮与G比较；漂浮时相等”连接证据与结论。如果出现“只比较材料密度”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **只比较材料密度**：圈出研究对象和关键条件，再重新选择模型。\r
- **浮沉力箭头错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“提着书包水平走，手对书包做机械功吗？”。乘法：由单位量和份数求总量；单位换算：让同类量在计算前使用统一单位。\r
...
## 开课前｜数学准备\r
\r
数学前置：乘法、单位换算。本课数学只服务于物理问题“提着书包水平走，手对书包做机械功吗？”。乘法：由单位量和份数求总量；单位换算：让同类量在计算前使用统一单位。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习乘法、单位换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：对比推车前进、提物静止、提物水平走。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“有力就判做功”。任务：对比推车前进、提物静止、提物水平走。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“力与力方向距离的乘积”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 10 N水平推物前进3 m，做功。\r
\r
   **答案**：30 J。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“力与位移夹向图”，标出研究对象、关键方向或变量，并用图得出“力与力方向距离的乘积”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“力与力方向距离的乘积”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：提着书包水平走，手对书包做机械功吗？\r
\r
   **答案**：先圈定对象和条件，再用“力与力方向距离的乘积”连接证据与结论。如果出现“漏力方向”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **漏力方向**：重读题目，只圈出决定答案的条件，再作答。\r
- **有力就判做功**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“同样爬楼，跑上去和走上去哪里不同？”。除法：求出每一单位对应多少；比率：公平比较两个量的相对大小。\r
...
## 开课前｜数学准备\r
\r
数学前置：除法、比率。本课数学只服务于物理问题“同样爬楼，跑上去和走上去哪里不同？”。除法：求出每一单位对应多少；比率：公平比较两个量的相对大小。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习除法、比率，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：记录走与快走同一楼梯的时间，比较功率。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“瓦特单位错”。任务：记录走与快走同一楼梯的时间，比较功率。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“功与时间的比率”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 做600 J功用3 s，功率。\r
\r
   **答案**：200 W。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“爬楼功时间图”，标出研究对象、关键方向或变量，并用图得出“功与时间的比率”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“记录走与快走同一楼梯的时间，比较功率”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“功与时间的比率”完成一次清楚比较：先定对象和条件，再记录能支持或否定“功率表示单位时间做功”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：同样爬楼，跑上去和走上去哪里不同？\r
\r
   **答案**：先圈定对象和条件，再用“功与时间的比率”连接证据与结论。如果出现“功多等同功率大”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **功多等同功率大**：回到现象和核心句，用自己的话重新解释一次。\r
- **瓦特单位错**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“秋千为什么能来回摆但不会越摆越高？”。图像趋势：判断一个量增大时另一个量怎样变。\r
...
## 开课前｜数学准备\r
\r
数学前置：图像趋势。本课数学只服务于物理问题“秋千为什么能来回摆但不会越摆越高？”。图像趋势：判断一个量增大时另一个量怎样变。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习图像趋势，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：滚小球下斜面撞纸盒，改变高度或质量比较。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“把能量说成力”。任务：滚小球下斜面撞纸盒，改变高度或质量比较。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“动能↔势能，考虑阻力时部分转为内能”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 小球从高处下滑时能量怎样变。\r
\r
   **答案**：重力势能减小、动能增大。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“秋千能量条图”，标出研究对象、关键方向或变量，并用图得出“动能↔势能，考虑阻力时部分转为内能”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“滚小球下斜面撞纸盒，改变高度或质量比较”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“动能↔势能，考虑阻力时部分转为内能”完成一次清楚比较：先定对象和条件，再记录能支持或否定“运动和位置可储存机械能”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：秋千为什么能来回摆但不会越摆越高？\r
\r
   **答案**：先圈定对象和条件，再用“动能↔势能，考虑阻力时部分转为内能”连接证据与结论。如果出现“忽略系统与阻力”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **忽略系统与阻力**：圈出研究对象和关键条件，再重新选择模型。\r
- **把能量说成力**：回到现象和核心句，用自己的话重新解释一次。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“为什么用长扳手更省力？”。乘法：由单位量和份数求总量；比例：判断两个量是否按固定关系变化；垂线：建立法线或力臂。\r
...
## 开课前｜数学准备\r
\r
数学前置：乘法、比例、垂线。本课数学只服务于物理问题“为什么用长扳手更省力？”。乘法：由单位量和份数求总量；比例：判断两个量是否按固定关系变化；垂线：建立法线或力臂。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习乘法、比例、垂线，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：改变钩码位置与数量，记录平衡时力和力臂。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“比例求解错”。任务：改变钩码位置与数量，记录平衡时力和力臂。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“力×力臂两侧平衡”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 阻力20 N、阻力臂0.1 m，动力臂0.5 m。\r
\r
   **答案**：动力4 N。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“杠杆五要素图”，标出研究对象、关键方向或变量，并用图得出“力×力臂两侧平衡”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：力或力臂；观察测量：杠杆平衡时另一侧的力或力臂；关键控制：杠杆水平、支点、钩码规格和读力方向；证据记录：多组F1、l1、F2、l2乘积。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：为什么用长扳手更省力？\r
\r
   **答案**：先圈定对象和条件，再用“力×力臂两侧平衡”连接证据与结论。如果出现“力臂画成杆长”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **力臂画成杆长**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **比例求解错**：物理关系不变，只把计算过程单独重算一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“使用机械省了力，是否也省了功？”。分数：表示部分与整体或两个量的比；百分数：表示有效部分占总体的比例。\r
from_previous: 承接L045《杠杆模型与平衡条件》的绕固定点转动的硬棒可抽象为杠杆。\r
to_next: 为L047《分子热运动与内能》准备从扩散和温度变化连接微观运动模型。\r
...
## 开课前｜数学准备\r
\r
数学前置：分数、百分数。本课数学只服务于物理问题“使用机械省了力，是否也省了功？”。分数：表示部分与整体或两个量的比；百分数：表示有效部分占总体的比例。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习分数、百分数，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用定滑轮和动滑轮提同一物体，比较有用功、额外功和总功。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“百分数错误”。任务：用定滑轮和动滑轮提同一物体，比较有用功、额外功和总功。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“有用功、额外功与总功的能量账本”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 有用功80 J、总功100 J，效率。\r
\r
   **答案**：80%；效率不可能超过100%。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“有用额外总功流图”，标出研究对象、关键方向或变量，并用图得出“有用功、额外功与总功的能量账本”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“用定滑轮和动滑轮提同一物体，比较有用功、额外功和总功”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“有用功、额外功与总功的能量账本”完成一次清楚比较：先定对象和条件，再记录能支持或否定“机械效率表示有用功占总功的比例”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：使用机械省了力，是否也省了功？\r
\r
   **答案**：先圈定对象和条件，再用“有用功、额外功与总功的能量账本”连接证据与结论。如果出现“说机械省功”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **说机械省功**：写出这个关系的适用条件，再判断本题能否使用。\r
- **百分数错误**：物理关系不变，只把计算过程单独重算一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L047《分子热运动与内能》准备从扩散和温度变化连接微观运动模型。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
core_concept: 分子不停做无规则运动；内能包含分子动能和分子间相互作用势能\r
core_model: 从扩散和温度变化连接微观运动模型\r
formula: "—"\r
math_prerequisite: [无]\r
math_connection: 本课不要求新的数学工具，重点用观察、分类或画图表达证据。\r
...
## 为什么要学它？\r
\r
想一想这个生活场景：冷水与热水各滴一滴色素，只比较扩散快慢。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**分子不停做无规则运动；内能包含分子动能和分子间相互作用势能**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 把现象画出来，建立模型\r
\r
画：**扩散微粒图**。图上只保留对象、关键方向/变量和边界。\r
\r
模型句：**从扩散和温度变化连接微观运动模型**。\r
\r
## 正式物理知识\r
\r
- 概念：分子不停做无规则运动；内能包含分子动能和分子间相互作用势能。\r
- 关系：本课无须背公式，先稳定概念和图。\r
...
\r
**六步建模**：对象是谁 → 已知什么 → 求什么 → 画最简图 → 选“从扩散和温度变化连接微观运动模型” → 检查单位和意义。\r
\r
**答案**：分子无规则运动更剧烈，内能通常增大。\r
\r
## 一句话收束\r
\r
今天记住：**分子不停做无规则运动；内能包含分子动能和分子间相互作用势能；从扩散和温度变化连接微观运动模型。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“内能等同热量”。任务：冷水与热水各滴一滴色素，只比较扩散快慢。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“从扩散和温度变化连接微观运动模型”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 同一物体、状态不变时温度升高，分子运动和内能通常怎样。\r
\r
   **答案**：分子无规则运动更剧烈，内能通常增大。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“扩散微粒图”，标出研究对象、关键方向或变量，并用图得出“从扩散和温度变化连接微观运动模型”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“冷水与热水各滴一滴色素，只比较扩散快慢”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“从扩散和温度变化连接微观运动模型”完成一次清楚比较：先定对象和条件，再记录能支持或否定“分子不停做无规则运动；内能包含分子动能和分子间相互作用势能”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：打开香水后，远处为什么也能闻到？\r
\r
   **答案**：先圈定对象和条件，再用“从扩散和温度变化连接微观运动模型”连接证据与结论。如果出现“分子热运动等同物体移动”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **分子热运动等同物体移动**：回到现象和核心句，用自己的话重新解释一次。\r
- **内能等同热量**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_prerequisite: [无]\r
math_connection: 本课不要求新的数学工具，重点用观察、分类或画图表达证据。\r
from_previous: 承接L047《分子热运动与内能》的分子不停做无规则运动；内能包含分子动能和分子间相互作用势能。\r
...
## 为什么要学它？\r
\r
想一想这个生活场景：搓手、弯折铁丝、接触温水，给路径分类。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“两路径混淆”。任务：搓手、弯折铁丝、接触温水，给路径分类。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“能量转移与能量转化两类路径”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 压缩空气使其变热属于哪种。\r
\r
   **答案**：做功，机械能转化为内能。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“内能路径图”，标出研究对象、关键方向或变量，并用图得出“能量转移与能量转化两类路径”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“搓手、弯折铁丝、接触温水，给路径分类”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“能量转移与能量转化两类路径”完成一次清楚比较：先定对象和条件，再记录能支持或否定“热传递和做功都能改变内能”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：搓手和烤火都能变暖，能量路径相同吗？\r
\r
   **答案**：先圈定对象和条件，再用“能量转移与能量转化两类路径”连接证据与结论。如果出现“热量说成物体含有”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **热量说成物体含有**：回到现象和核心句，用自己的话重新解释一次。\r
- **两路径混淆**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L047《分子热运动与内能》的分子不停做无规则运动；内能包含分子动能和分子间相互作用势能。\r
\r
## 下一课会发生什么\r
\r
...
math_connection: 本课数学只服务于物理问题“海边昼夜温差为什么比沙漠小？”。乘法：由单位量和份数求总量；正负数：区分零点两侧或变化方向。\r
...
## 开课前｜数学准备\r
\r
数学前置：乘法、正负数。本课数学只服务于物理问题“海边昼夜温差为什么比沙漠小？”。乘法：由单位量和份数求总量；正负数：区分零点两侧或变化方向。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习乘法、正负数，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：等质量水和沙接受相同加热，比较升温。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“科学记数法错”。任务：等质量水和沙接受相同加热，比较升温。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“质量、温差、物质共同决定吸热”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 2 kg水升高5℃，c=4.2×10³，吸热。\r
\r
   **答案**：4.2×10^4 J。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“水沙升温曲线图”，标出研究对象、关键方向或变量，并用图得出“质量、温差、物质共同决定吸热”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“等质量水和沙接受相同加热，比较升温”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“质量、温差、物质共同决定吸热”完成一次清楚比较：先定对象和条件，再记录能支持或否定“比热容表示单位质量升高1℃所需热量”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：海边昼夜温差为什么比沙漠小？\r
\r
   **答案**：先圈定对象和条件，再用“质量、温差、物质共同决定吸热”连接证据与结论。如果出现“温差用末温”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **温差用末温**：物理关系不变，只把计算过程单独重算一遍。\r
- **科学记数法错**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“同质量木柴和天然气为什么放热不同？”。乘法：由单位量和份数求总量；科学记数法：简洁表示很大或很小的数。\r
from_previous: 承接L049《比热容：相同热量为何升温不同》的比热容表示单位质量升高1℃所需热量。\r
to_next: 为L051《能量守恒：能量去了哪里》准备输入能量=有效转化+其他形式能量。\r
...
## 开课前｜数学准备\r
\r
数学前置：乘法、科学记数法。本课数学只服务于物理问题“同质量木柴和天然气为什么放热不同？”。乘法：由单位量和份数求总量；科学记数法：简洁表示很大或很小的数。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习乘法、科学记数法，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：比较资料中同质量不同燃料完全燃烧的放热量并画能量链。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“把热值随质量改变”。任务：比较资料中同质量不同燃料完全燃烧的放热量并画能量链。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“燃料质量与完全燃烧放热的比例模型”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 0.1 kg燃料热值3×10^7 J/kg，完全燃烧放热。\r
\r
   **答案**：3×10^6 J。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“燃料能量流图”，标出研究对象、关键方向或变量，并用图得出“燃料质量与完全燃烧放热的比例模型”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“比较资料中同质量不同燃料完全燃烧的放热量并画能量链”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“燃料质量与完全燃烧放热的比例模型”完成一次清楚比较：先定对象和条件，再记录能支持或否定“热值描述单位质量燃料完全燃烧时放出的热量”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：同质量木柴和天然气为什么放热不同？\r
\r
   **答案**：先圈定对象和条件，再用“燃料质量与完全燃烧放热的比例模型”连接证据与结论。如果出现“漏完全燃烧条件”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **漏完全燃烧条件**：重读题目，只圈出决定答案的条件，再作答。\r
- **把热值随质量改变**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L051《能量守恒：能量去了哪里》准备输入能量=有效转化+其他形式能量。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
core_concept: 能量总量守恒，但转化后的能量不一定都便于继续利用\r
core_model: 输入能量=有效转化+其他形式能量\r
formula: "E入=E有效+E其他"\r
math_prerequisite: [加法, 百分数]\r
math_connection: 本课数学只服务于物理问题“能量守恒，永动机为什么仍不可能？”。加法：合并同一过程中的各段量；百分数：表示有效部分占总体的比例。\r
...
estimated_practice_minutes: 10\r
difficulty: 基础—典型\r
common_errors: [C1守恒等同能量形式不变, C7把有效能量写得大于输入能量]\r
...
## 开课前｜数学准备\r
\r
数学前置：加法、百分数。本课数学只服务于物理问题“能量守恒，永动机为什么仍不可能？”。加法：合并同一过程中的各段量；百分数：表示有效部分占总体的比例。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习加法、百分数，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：给手机充电能量流贴标签，区分有效转化和其他形式能量。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 看现象 / 做实验\r
\r
任务：给手机充电能量流贴标签，区分有效转化和其他形式能量。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**能量总量守恒，但转化后的能量不一定都便于继续利用**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 把现象画出来，建立模型\r
\r
画：**能量流桑基简图**。图上只保留对象、关键方向/变量和边界。\r
\r
模型句：**输入能量=有效转化+其他形式能量**。\r
\r
## 正式物理知识\r
\r
- 概念：能量总量守恒，但转化后的能量不一定都便于继续利用。\r
- 关系：E入=E有效+E其他\r
- 为什么需要：用一个数量关系回答“能量守恒，永动机为什么仍不可能？”。\r
- 量与单位：各项都用同一种能量单位。\r
- 怎样变化：输入固定时其他形式能量越少，有效转化越多。\r
- 适用边界：守恒不等于所有能量都能按原用途继续利用。\r
\r
\r
\r
## 一个典型例题\r
\r
**题目**：输入100 J，有效转化70 J，其他形式能量多少？\r
\r
**六步建模**：对象是谁 → 已知什么 → 求什么 → 画最简图 → 选“输入能量=有效转化+其他形式能量” → 检查单位和意义。\r
\r
**答案**：30 J；总量守恒不等于所有能量都能按原用途继续利用。\r
\r
## 一句话收束\r
\r
今天记住：**能量总量守恒，但转化后的能量不一定都便于继续利用；输入能量=有效转化+其他形式能量。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“把有效能量写得大于输入能量”。任务：给手机充电能量流贴标签，区分有效转化和其他形式能量。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“输入能量=有效转化+其他形式能量”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 输入100 J，有效转化70 J，其他形式能量多少。\r
\r
   **答案**：30 J；总量守恒不等于所有能量都能按原用途继续利用。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“能量流桑基简图”，标出研究对象、关键方向或变量，并用图得出“输入能量=有效转化+其他形式能量”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“输入能量=有效转化+其他形式能量”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：能量守恒，永动机为什么仍不可能？\r
\r
   **答案**：先圈定对象和条件，再用“输入能量=有效转化+其他形式能量”连接证据与结论。如果出现“守恒等同能量形式不变”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **守恒等同能量形式不变**：回到现象和核心句，用自己的话重新解释一次。\r
- **把有效能量写得大于输入能量**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_prerequisite: [无]\r
math_connection: 本课不要求新的数学工具，重点用观察、分类或画图表达证据。\r
from_previous: 承接L051《能量守恒：能量去了哪里》的能量总量守恒，但转化后的能量不一定都便于继续利用。\r
...
## 为什么要学它？\r
\r
想一想这个生活场景：电池、灯泡、开关试接，先检查短路风险。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“电路图元件画错”。任务：电池、灯泡、开关试接，先检查短路风险。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“电源—导线—用电器—开关闭环”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 开关闭合但灯不亮先查什么。\r
\r
   **答案**：通路是否完整、接触是否可靠。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“最简电路图”，标出研究对象、关键方向或变量，并用图得出“电源—导线—用电器—开关闭环”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“电池、灯泡、开关试接，先检查短路风险”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“电源—导线—用电器—开关闭环”完成一次清楚比较：先定对象和条件，再记录能支持或否定“持续电流需要电源和闭合通路”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：灯泡亮起来，电流必须走怎样的路？\r
\r
   **答案**：先圈定对象和条件，再用“电源—导线—用电器—开关闭环”连接证据与结论。如果出现“把电流消耗掉”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把电流消耗掉**：圈出研究对象和关键条件，再重新选择模型。\r
- **电路图元件画错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L051《能量守恒：能量去了哪里》的能量总量守恒，但转化后的能量不一定都便于继续利用。\r
\r
## 下一课会发生什么\r
\r
...
formula: "—"\r
math_prerequisite: [分类]\r
math_connection: 本课数学只服务于物理问题“家里一盏灯坏了，其他灯为什么还能亮？”。分类：按同一规则区分不同情形。\r
...
## 开课前｜数学准备\r
\r
数学前置：分类。本课数学只服务于物理问题“家里一盏灯坏了，其他灯为什么还能亮？”。分类：按同一规则区分不同情形。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习分类，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：用两灯搭串联与并联，断开一灯观察另一灯。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“漏节点”。任务：用两灯搭串联与并联，断开一灯观察另一灯。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“从电流路径识别连接方式”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 家庭灯为什么并联。\r
\r
   **答案**：各支路可独立工作且两端电压相同。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“串并联路径图”，标出研究对象、关键方向或变量，并用图得出“从电流路径识别连接方式”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“用两灯搭串联与并联，断开一灯观察另一灯”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“从电流路径识别连接方式”完成一次清楚比较：先定对象和条件，再记录能支持或否定“串联一条路径，并联多条支路”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：家里一盏灯坏了，其他灯为什么还能亮？\r
\r
   **答案**：先圈定对象和条件，再用“从电流路径识别连接方式”连接证据与结论。如果出现“按元件摆放形状判断”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **按元件摆放形状判断**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **漏节点**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“电流表为什么必须串进被测支路？”。刻度：按分度值正确读数；小数：准确记录和比较测量值。\r
...
## 开课前｜数学准备\r
\r
数学前置：刻度、小数。本课数学只服务于物理问题“电流表为什么必须串进被测支路？”。刻度：按分度值正确读数；小数：准确记录和比较测量值。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习刻度、小数，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：识别量程和分度值，安全接入小灯泡支路。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“量程读错”。任务：识别量程和分度值，安全接入小灯泡支路。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“串联、正进负出、量程合适”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 0～0.6 A量程每小格0.02 A，指17格。\r
\r
   **答案**：0.34 A。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“电流表接线图”，标出研究对象、关键方向或变量，并用图得出“串联、正进负出、量程合适”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量类，无自变量；观察测量：支路电流；关键控制：量程、正负接线、串联位置和试触；证据记录：量程、分度值和示数。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：电流表为什么必须串进被测支路？\r
\r
   **答案**：先圈定对象和条件，再用“串联、正进负出、量程合适”连接证据与结论。如果出现“并联电流表”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **并联电流表**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **量程读错**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“电流经过灯泡后会被“用掉”吗？”。加法：合并同一过程中的各段量；表格：配对记录同一条件下的数据。\r
from_previous: 承接L054《电流表：让电流可测量》的电流表测通过某处的电流。\r
to_next: 为L056《电压表：测量元件两端电压》准备电压表并联、正进负出、量程合适。\r
...
## 开课前｜数学准备\r
\r
数学前置：加法、表格。本课数学只服务于物理问题“电流经过灯泡后会被“用掉”吗？”。加法：合并同一过程中的各段量；表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习加法、表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：换测多个位置和不同灯泡，记录三组数据。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“把电流当消耗品”。任务：换测多个位置和不同灯泡，记录三组数据。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“节点电流守恒模型”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 并联两支路0.2 A与0.3 A，干路。\r
\r
   **答案**：0.5 A。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“节点电流箭头图”，标出研究对象、关键方向或变量，并用图得出“节点电流守恒模型”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量位置或支路；观察测量：各处电流；关键控制：电源、灯泡组合、量程和连接方式；证据记录：不同位置和不同灯泡组合的多组电流。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：电流经过灯泡后会被“用掉”吗？\r
\r
   **答案**：先圈定对象和条件，再用“节点电流守恒模型”连接证据与结论。如果出现“只测一组”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **只测一组**：重读题目，只圈出决定答案的条件，再作答。\r
- **把电流当消耗品**：回到现象和核心句，用自己的话重新解释一次。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L056《电压表：测量元件两端电压》准备电压表并联、正进负出、量程合适。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
core_question: 怎样测出灯泡两端的电压而不改变原来的支路？\r
core_concept: 电压表测量元件两端的电压\r
core_model: 电压表并联、正进负出、量程合适\r
formula: "—"\r
math_prerequisite: [刻度, 小数]\r
math_connection: 本课数学只服务于物理问题“怎样测出灯泡两端的电压而不改变原来的支路？”。刻度：按分度值正确读数；小数：准确记录和比较测量值。\r
...
## 今天只学一件事\r
\r
回答：**怎样测出灯泡两端的电压而不改变原来的支路？**\r
\r
## 开课前｜数学准备\r
\r
数学前置：刻度、小数。本课数学只服务于物理问题“怎样测出灯泡两端的电压而不改变原来的支路？”。刻度：按分度值正确读数；小数：准确记录和比较测量值。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习刻度、小数，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：辨量程和分度值，再把电压表跨接在灯泡两端。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**电压表测量元件两端的电压**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 整理证据，建立模型\r
\r
画：**电压表接线图**。图上只保留对象、关键方向/变量和边界。\r
\r
模型句：**电压表并联、正进负出、量程合适**。\r
\r
## 正式物理知识\r
\r
- 概念：电压表测量元件两端的电压。\r
- 关系：本课无须背公式，先稳定概念和图。\r
- 本课不用计算公式。模型边界：电压表并联、正进负出、量程合适。\r
- 先用图和证据判断，不把一句口诀套到所有情境。\r
\r
\r
\r
...
\r
**六步建模**：对象是谁 → 已知什么 → 求什么 → 画最简图 → 选“电压表并联、正进负出、量程合适” → 检查单位和意义。\r
\r
**答案**：2.3 V。\r
\r
## 一句话收束\r
\r
今天记住：**电压表测量元件两端的电压；电压表并联、正进负出、量程合适。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“正负接线错”。任务：辨量程和分度值，再把电压表跨接在灯泡两端。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“电压表并联、正进负出、量程合适”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 0～3 V量程每小格0.1 V，指23格。\r
\r
   **答案**：2.3 V。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“电压表接线图”，标出研究对象、关键方向或变量，并用图得出“电压表并联、正进负出、量程合适”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量类，无自变量；观察测量：元件两端电压；关键控制：量程、正负接线和并联端点；证据记录：量程、分度值和示数。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：怎样测出灯泡两端的电压而不改变原来的支路？\r
\r
   **答案**：先圈定对象和条件，再用“电压表并联、正进负出、量程合适”连接证据与结论。如果出现“把电压表串联”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把电压表串联**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **正负接线错**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_prerequisite: [加法, 表格]\r
math_connection: 本课数学只服务于物理问题“两只串联灯怎样“分”电压？”。加法：合并同一过程中的各段量；表格：配对记录同一条件下的数据。\r
from_previous: 承接L056《电压表：测量元件两端电压》的电压表测量元件两端的电压。\r
to_next: 为L058《滑动变阻器：用有效长度调电阻》准备先找接入端，再圈出有效长度，最后判断电阻变化。\r
...
## 开课前｜数学准备\r
\r
数学前置：加法、表格。本课数学只服务于物理问题“两只串联灯怎样“分”电压？”。加法：合并同一过程中的各段量；表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习加法、表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：分别测电源、各灯两端电压并换灯复测。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“把电流规律套给电压”。任务：分别测电源、各灯两端电压并换灯复测。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“回路电压分配模型”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 串联两灯1.2 V、1.8 V，电源电压。\r
\r
   **答案**：3.0 V。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“串并联电压图”，标出研究对象、关键方向或变量，并用图得出“回路电压分配模型”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：测量元件或支路；观察测量：各部分两端电压；关键控制：电源、元件组合、量程和连接方式；证据记录：串联总分电压与并联支路电压多组数据。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：两只串联灯怎样“分”电压？\r
\r
   **答案**：先圈定对象和条件，再用“回路电压分配模型”连接证据与结论。如果出现“测量端点错”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **测量端点错**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **把电流规律套给电压**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L056《电压表：测量元件两端电压》的电压表测量元件两端的电压。\r
\r
## 下一课会发生什么\r
\r
为L058《滑动变阻器：用有效长度调电阻》准备先找接入端，再圈出有效长度，最后判断电阻变化。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
pep_mapping: 九年第16章\r
core_question: 滑片为什么能连续改变电路中的电流？\r
core_concept: 电阻表示导体对电流的阻碍作用，变阻器利用接入电路的电阻丝长度来调节电阻\r
core_model: 先找接入端，再圈出有效长度，最后判断电阻变化\r
formula: "—"\r
math_prerequisite: [比例]\r
math_connection: 本课数学只服务于物理问题“滑片为什么能连续改变电路中的电流？”。比例：判断两个量是否按固定关系变化。\r
...
---\r
\r
# 第58课：滑动变阻器：用有效长度调电阻\r
\r
## 今天只学一件事\r
\r
回答：**滑片为什么能连续改变电路中的电流？**\r
\r
## 开课前｜数学准备\r
\r
数学前置：比例。本课数学只服务于物理问题“滑片为什么能连续改变电路中的电流？”。比例：判断两个量是否按固定关系变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习比例，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：固定一上一下两个接线柱，只移动滑片并圈出实际接入的电阻丝。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 看现象 / 做实验\r
\r
任务：固定一上一下两个接线柱，只移动滑片并圈出实际接入的电阻丝。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**电阻表示导体对电流的阻碍作用，变阻器利用接入电路的电阻丝长度来调节电阻**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 把现象画出来，建立模型\r
\r
画：**变阻器有效段图**。图上只保留对象、关键方向/变量和边界。\r
\r
模型句：**先找接入端，再圈出有效长度，最后判断电阻变化**。\r
\r
## 正式物理知识\r
\r
- 概念：电阻表示导体对电流的阻碍作用，变阻器利用接入电路的电阻丝长度来调节电阻。\r
- 关系：本课无须背公式，先稳定概念和图。\r
...
**题目**：滑片远离已接下端时电阻怎样？\r
\r
**六步建模**：对象是谁 → 已知什么 → 求什么 → 画最简图 → 选“先找接入端，再圈出有效长度，最后判断电阻变化” → 检查单位和意义。\r
\r
**答案**：有效长度变长，接入电阻增大。\r
\r
## 一句话收束\r
\r
今天记住：**电阻表示导体对电流的阻碍作用，变阻器利用接入电路的电阻丝长度来调节电阻；先找接入端，再圈出有效长度，最后判断电阻变化。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“不看有效段”。任务：固定一上一下两个接线柱，只移动滑片并圈出实际接入的电阻丝。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“先找接入端，再圈出有效长度，最后判断电阻变化”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 滑片远离已接下端时电阻怎样。\r
\r
   **答案**：有效长度变长，接入电阻增大。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“变阻器有效段图”，标出研究对象、关键方向或变量，并用图得出“先找接入端，再圈出有效长度，最后判断电阻变化”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“固定一上一下两个接线柱，只移动滑片并圈出实际接入的电阻丝”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“先找接入端，再圈出有效长度，最后判断电阻变化”完成一次清楚比较：先定对象和条件，再记录能支持或否定“电阻表示导体对电流的阻碍作用，变阻器利用接入电路的电阻丝长度来调节电阻”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：滑片为什么能连续改变电路中的电流？\r
\r
   **答案**：先圈定对象和条件，再用“先找接入端，再圈出有效长度，最后判断电阻变化”连接证据与结论。如果出现“同时接上面两个端子”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **同时接上面两个端子**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **不看有效段**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“电流会怎样随电压和电阻改变？”。比例：判断两个量是否按固定关系变化；图像：从形状和斜率读变化。\r
from_previous: 承接L058《滑动变阻器：用有效长度调电阻》的电阻表示导体对电流的阻碍作用，变阻器利用接入电路的电阻丝长度来调节电阻。\r
...
## 开课前｜数学准备\r
\r
数学前置：比例、图像。本课数学只服务于物理问题“电流会怎样随电压和电阻改变？”。比例：判断两个量是否按固定关系变化；图像：从形状和斜率读变化。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习比例、图像，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：实测同一电阻的三组U、I；再分析教师提供的同电压、不同电阻数据。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 操作与取证\r
\r
任务：实测同一电阻的三组U、I；再分析教师提供的同电压、不同电阻数据。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“倒写关系”。任务：实测同一电阻的三组U、I；再分析教师提供的同电压、不同电阻数据。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“控制变量建立I-U-R关系”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 6 V加在3 Ω电阻上，电流。\r
\r
   **答案**：2 A。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“I-U图像与电路图”，标出研究对象、关键方向或变量，并用图得出“控制变量建立I-U-R关系”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：电压或电阻，每轮只改一个；观察测量：电流；关键控制：被要求保持不变的量、温度和电表量程；证据记录：I-U数据图与I-R比较表。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：电流会怎样随电压和电阻改变？\r
\r
   **答案**：先圈定对象和条件，再用“控制变量建立I-U-R关系”连接证据与结论。如果出现“控制量未保持”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **控制量未保持**：重读题目，只圈出决定答案的条件，再作答。\r
- **倒写关系**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
承接L058《滑动变阻器：用有效长度调电阻》的电阻表示导体对电流的阻碍作用，变阻器利用接入电路的电阻丝长度来调节电阻。\r
\r
## 下一课会发生什么\r
\r
...
math_connection: 本课数学只服务于物理问题“电路题怎样先找对象再列式？”。方程：从物理关系反求未知量；单位换算：让同类量在计算前使用统一单位。\r
...
## 开课前｜数学准备\r
\r
数学前置：方程、单位换算。本课数学只服务于物理问题“电路题怎样先找对象再列式？”。方程：从物理关系反求未知量；单位换算：让同类量在计算前使用统一单位。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习方程、单位换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：给电路某电阻框边界，标其电压电流再计算。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“跨对象拼数据”。任务：给电路某电阻框边界，标其电压电流再计算。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“圈定研究对象再配U、I、R”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 0.5 A通过12 Ω电阻，电压。\r
\r
   **答案**：6 V。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“局部电路框图”，标出研究对象、关键方向或变量，并用图得出“圈定研究对象再配U、I、R”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“圈定研究对象再配U、I、R”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：电路题怎样先找对象再列式？\r
\r
   **答案**：先圈定对象和条件，再用“圈定研究对象再配U、I、R”连接证据与结论。如果出现“对象边界错”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **对象边界错**：圈出研究对象和关键条件，再重新选择模型。\r
- **跨对象拼数据**：写出这个关系的适用条件，再判断本题能否使用。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“未知电阻怎样用两个表测出来？”。除法：求出每一单位对应多少；表格：配对记录同一条件下的数据。\r
...
## 开课前｜数学准备\r
\r
数学前置：除法、表格。本课数学只服务于物理问题“未知电阻怎样用两个表测出来？”。除法：求出每一单位对应多少；表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习除法、表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：先最大电阻保护，再测三组U、I并分析。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“闭合前未调最大”。任务：先最大电阻保护，再测三组U、I并分析。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“电流表串联、电压表并联、变阻器保护”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 2.4 V、0.3 A，电阻。\r
\r
   **答案**：8 Ω。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“伏安法电路图”，标出研究对象、关键方向或变量，并用图得出“电流表串联、电压表并联、变阻器保护”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：滑动变阻器造成的工作状态；观察测量：同一时刻U、I及算得R；关键控制：待测电阻、接线、量程和闭合前最大阻值；证据记录：不少于三组U、I、R及异常值分析。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：未知电阻怎样用两个表测出来？\r
\r
   **答案**：先圈定对象和条件，再用“电流表串联、电压表并联、变阻器保护”连接证据与结论。如果出现“电表数据非同一时刻”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **电表数据非同一时刻**：重读题目，只圈出决定答案的条件，再作答。\r
- **闭合前未调最大**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“电器工作一段时间，转化了多少电能？”。乘法：由单位量和份数求总量；时间换算：处理本课中的数量或图示。\r
...
## 开课前｜数学准备\r
\r
数学前置：乘法、时间换算。本课数学只服务于物理问题“电器工作一段时间，转化了多少电能？”。乘法：由单位量和份数求总量；时间换算：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习乘法、时间换算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：读取家用电能表前后示数，计算一段时间的用电量。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“小时秒混用”。任务：读取家用电能表前后示数，计算一段时间的用电量。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“电压、电流和时间共同决定电功”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 220 V、2 A电器工作10 s，电功。\r
\r
   **答案**：4400 J。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“电能流与电能表图”，标出研究对象、关键方向或变量，并用图得出“电压、电流和时间共同决定电功”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 把例题信息整理成“对象—条件—关系—结论”四格，不增加题目没有给出的条件。\r
\r
   **答案**：对象和条件必须来自题目；关系使用“电压、电流和时间共同决定电功”；最后用单位或物理意义检查结论。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：电器工作一段时间，转化了多少电能？\r
\r
   **答案**：先圈定对象和条件，再用“电压、电流和时间共同决定电功”连接证据与结论。如果出现“电功与功率混淆”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **电功与功率混淆**：回到现象和核心句，用自己的话重新解释一次。\r
- **小时秒混用**：先统一单位，再把数值代入关系式。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“小灯泡在不同电压下亮度为何不同？”。乘法：由单位量和份数求总量；表格：配对记录同一条件下的数据。\r
...
estimated_practice_minutes: 10\r
difficulty: 基础—典型\r
common_errors: [C4把实际与额定混用, C9使灯泡长时间超过额定电压]\r
...
## 开课前｜数学准备\r
\r
数学前置：乘法、表格。本课数学只服务于物理问题“小灯泡在不同电压下亮度为何不同？”。乘法：由单位量和份数求总量；表格：配对记录同一条件下的数据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习乘法、表格，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：调变阻器使灯泡在低于和等于额定电压的状态工作，记录亮度与U、I。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 操作与取证\r
\r
任务：调变阻器使灯泡在低于和等于额定电压的状态工作，记录亮度与U、I。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
- 关键控制与规范：同一灯泡、接线、量程和不超过额定电压。\r
- 证据记录：低于和等于额定电压时的U、I、P。\r
- 结论规则：先描述数据共同趋势，再回答问题；异常数据不许静默删除，要复测或说明。\r
\r
\r
安全提示：只用实验室低压直流电源；改接电路前先断电，禁止接触家庭市电。 \`CORE\`实验应在教师或成人指导下完成。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“使灯泡长时间超过额定电压”。任务：调变阻器使灯泡在低于和等于额定电压的状态工作，记录亮度与U、I。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“同一工作状态测U和I后相乘”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 额定2.5 V时0.3 A，额定功率。\r
\r
   **答案**：0.75 W。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“测功率电路图”，标出研究对象、关键方向或变量，并用图得出“同一工作状态测U和I后相乘”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：小灯泡实际电压；观察测量：实际电流、功率和亮度；关键控制：同一灯泡、接线、量程和不超过额定电压；证据记录：低于和等于额定电压时的U、I、P。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：小灯泡在不同电压下亮度为何不同？\r
\r
   **答案**：先圈定对象和条件，再用“同一工作状态测U和I后相乘”连接证据与结论。如果出现“把实际与额定混用”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把实际与额定混用**：重读题目，只圈出决定答案的条件，再作答。\r
- **使灯泡长时间超过额定电压**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“电炉丝很热，连接导线为什么不该同样热？”。平方：判断倍数变化被放大的程度；乘法：由单位量和份数求总量。\r
...
## 开课前｜数学准备\r
\r
数学前置：平方、乘法。本课数学只服务于物理问题“电炉丝很热，连接导线为什么不该同样热？”。平方：判断倍数变化被放大的程度；乘法：由单位量和份数求总量。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习平方、乘法，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：串联两不同电阻丝，用相同电流比较温升。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“串并联时没辨相同量”。任务：串联两不同电阻丝，用相同电流比较温升。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“控制变量比较电阻丝产热”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 电流变2倍，其他不变，电热变几倍。\r
\r
   **答案**：4倍。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“串联电热对比图”，标出研究对象、关键方向或变量，并用图得出“控制变量比较电阻丝产热”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“串联两不同电阻丝，用相同电流比较温升”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“控制变量比较电阻丝产热”完成一次清楚比较：先定对象和条件，再记录能支持或否定“电热与电流平方、电阻、时间有关”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：电炉丝很热，连接导线为什么不该同样热？\r
\r
   **答案**：先圈定对象和条件，再用“控制变量比较电阻丝产热”连接证据与结论。如果出现“漏平方”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **漏平方**：物理关系不变，只把计算过程单独重算一遍。\r
- **串并联时没辨相同量**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“保险装置为什么装在火线上？”。估算：先判断结果数量级是否合理。\r
...
## 开课前｜数学准备\r
\r
数学前置：估算。本课数学只服务于物理问题“保险装置为什么装在火线上？”。估算：先判断结果数量级是否合理。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习估算，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：识别三孔插座、总开关和漏电保护器，不接触市电。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“湿手操作”。任务：识别三孔插座、总开关和漏电保护器，不接触市电。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“火线—用电器—零线与接地保护”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 多个大功率电器同插座有何风险。\r
\r
   **答案**：总电流过大导致导线过热和火灾风险。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“家庭电路安全图”，标出研究对象、关键方向或变量，并用图得出“火线—用电器—零线与接地保护”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“识别三孔插座、总开关和漏电保护器，不接触市电”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“火线—用电器—零线与接地保护”完成一次清楚比较：先定对象和条件，再记录能支持或否定“家庭电路并联，保护装置切断危险通路”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：保险装置为什么装在火线上？\r
\r
   **答案**：先圈定对象和条件，再用“火线—用电器—零线与接地保护”连接证据与结论。如果出现“开关接零线”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **开关接零线**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **湿手操作**：按对象、条件、单位逐项检查一遍。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“磁体没有接触，为什么能推动小磁针？”。方向：处理本课中的数量或图示；空间方向：把电流、磁场或力的方向说清楚。\r
...
## 开课前｜数学准备\r
\r
数学前置：方向、空间方向。本课数学只服务于物理问题“磁体没有接触，为什么能推动小磁针？”。方向：处理本课中的数量或图示；空间方向：把电流、磁场或力的方向说清楚。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习方向、空间方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：磁体周围放多枚小磁针并标N极方向。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“方向画反”。任务：磁体周围放多枚小磁针并标N极方向。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“小磁针N极受力方向定义场方向”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 条形磁体外部磁感线方向。\r
\r
   **答案**：从N极到S极。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“条形磁体场线图”，标出研究对象、关键方向或变量，并用图得出“小磁针N极受力方向定义场方向”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“磁体周围放多枚小磁针并标N极方向”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“小磁针N极受力方向定义场方向”完成一次清楚比较：先定对象和条件，再记录能支持或否定“磁场对放入其中的磁体有力作用”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：磁体没有接触，为什么能推动小磁针？\r
\r
   **答案**：先圈定对象和条件，再用“小磁针N极受力方向定义场方向”连接证据与结论。如果出现“把磁感线当真实线”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **把磁感线当真实线**：回到现象和核心句，用自己的话重新解释一次。\r
- **方向画反**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“改变电流方向，螺线管磁极会变吗？”。空间方向：把电流、磁场或力的方向说清楚；方向：处理本课中的数量或图示。\r
...
## 开课前｜数学准备\r
\r
数学前置：空间方向、方向。本课数学只服务于物理问题“改变电流方向，螺线管磁极会变吗？”。空间方向：把电流、磁场或力的方向说清楚；方向：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习空间方向、方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：改变电流方向，记录两端小磁针N极指向。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“只改电池位置不记录”。任务：改变电流方向，记录两端小磁针N极指向。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“电流方向决定磁场方向”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 电流反向后磁极怎样。\r
\r
   **答案**：N、S极对调。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“螺线管小磁针图”，标出研究对象、关键方向或变量，并用图得出“电流方向决定磁场方向”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：电流方向；观察测量：螺线管两端磁极方向；关键控制：线圈绕向、位置和小磁针初始状态；证据记录：电流方向与N/S极对应记录。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：改变电流方向，螺线管磁极会变吗？\r
\r
   **答案**：先圈定对象和条件，再用“电流方向决定磁场方向”连接证据与结论。如果出现“电流方向与场方向混淆”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **电流方向与场方向混淆**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **只改电池位置不记录**：重读题目，只圈出决定答案的条件，再作答。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
math_connection: 本课数学只服务于物理问题“通电线圈为什么能转起来？”。方向：处理本课中的数量或图示。\r
...
## 开课前｜数学准备\r
\r
数学前置：方向。本课数学只服务于物理问题“通电线圈为什么能转起来？”。方向：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：让通电线框在磁场中运动并分别反向电流、磁场。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“只反一项却判方向不变”。任务：让通电线框在磁场中运动并分别反向电流、磁场。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“电能→机械能；电流或磁场反向则受力反向”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 电动机主要把什么能转为什么能。\r
\r
   **答案**：电能转化为机械能。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“电动机受力图”，标出研究对象、关键方向或变量，并用图得出“电能→机械能；电流或磁场反向则受力反向”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“让通电线框在磁场中运动并分别反向电流、磁场”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“电能→机械能；电流或磁场反向则受力反向”完成一次清楚比较：先定对象和条件，再记录能支持或否定“通电导线在磁场中受力”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：通电线圈为什么能转起来？\r
\r
   **答案**：先圈定对象和条件，再用“电能→机械能；电流或磁场反向则受力反向”连接证据与结论。如果出现“与发电机混淆”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **与发电机混淆**：圈出研究对象和关键条件，再重新选择模型。\r
- **只反一项却判方向不变**：重画最简图，逐一核对方向、箭头、虚实线和标注。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
formula: "—"\r
math_prerequisite: [方向]\r
math_connection: 本课数学只服务于物理问题“没有电池，怎样让导线中出现电流？”。方向：处理本课中的数量或图示。\r
from_previous: 承接L068《磁场对电流的作用与电动机》的通电导线在磁场中受力。\r
to_next: 为L070《能源与现代技术：用证据选择方案》准备需求—证据—约束—方案—评价。\r
...
## 开课前｜数学准备\r
\r
数学前置：方向。本课数学只服务于物理问题“没有电池，怎样让导线中出现电流？”。方向：处理本课中的数量或图示。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习方向，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：改变导体运动方向、磁场方向与是否闭合，观察灵敏电流计。\r
\r
## 先猜并设计\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“与电动机能量链混淆”。任务：改变导体运动方向、磁场方向与是否闭合，观察灵敏电流计。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“机械运动—磁场变化—电能”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 导体静止在磁场中是否有感应电流。\r
\r
   **答案**：没有；还需闭合且切割磁感线。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“切割磁感线图”，标出研究对象、关键方向或变量，并用图得出“机械运动—磁场变化—电能”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 本课核心实验怎样保证结论可信？写出主动改变的量、观察测量的量和关键控制条件。\r
\r
   **答案**：主动改变：导体运动方向、磁场方向或电路通断，每轮只改一个；观察测量：灵敏电流计是否偏转及方向；关键控制：导体、磁体、运动速度范围和接线；证据记录：条件组合表和偏转结果。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：没有电池，怎样让导线中出现电流？\r
\r
   **答案**：先圈定对象和条件，再用“机械运动—磁场变化—电能”连接证据与结论。如果出现“漏闭合条件”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **漏闭合条件**：重读题目，只圈出决定答案的条件，再作答。\r
- **与电动机能量链混淆**：圈出研究对象和关键条件，再重新选择模型。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
...
## 下一课会发生什么\r
\r
为L070《能源与现代技术：用证据选择方案》准备需求—证据—约束—方案—评价。\r
\r
## 间隔复习\r
\r
当天口述核心句；第2天做一道基础题；第3天换一个情境；第7天和相邻模型一起练；第14天不看卡片解释一次。复习优先处理真正出错的步骤，不重复抄答案。\r
...
core_question: 一种能源方案“能用”，是否就一定适合这个场景？\r
core_concept: 能源方案要按需求比较稳定性、安全、环境和成本\r
core_model: 需求—证据—约束—方案—评价\r
formula: "—"\r
math_prerequisite: [百分数, 大小比较]\r
math_connection: 本课数学只服务于物理问题“一种能源方案“能用”，是否就一定适合这个场景？”。百分数：表示有效部分占总体的比例；大小比较：用同一标准比较证据。\r
...
estimated_practice_minutes: 10\r
difficulty: 基础—典型\r
common_errors: [C4只看单一指标, C1把可再生能源等同于没有环境影响]\r
review_links: [L069, L067, L063]\r
---\r
\r
# 第70课：能源与现代技术：用证据选择方案\r
\r
## 今天只学一件事\r
\r
回答：**一种能源方案“能用”，是否就一定适合这个场景？**\r
\r
## 开课前｜数学准备\r
\r
数学前置：百分数、大小比较。本课数学只服务于物理问题“一种能源方案“能用”，是否就一定适合这个场景？”。百分数：表示有效部分占总体的比例；大小比较：用同一标准比较证据。\r
\r
**数学小补丁**：若不稳定，先做5分钟补丁：用一个生活数例复习百分数、大小比较，只练本课会用到的一步。\r
\r
## 为什么要学它？\r
\r
想一想这个生活场景：读取太阳能、风能和市电的三项数据，只为“节能小屋”选择一个组合方案。\r
\r
## 先猜一猜\r
\r
把答案先写成一句话：结果会怎样？你依据的是“看起来”，还是一个可检查的条件？先保留答案，不马上判对错。\r
...
## 看现象 / 做实验\r
\r
任务：读取太阳能、风能和市电的三项数据，只为“节能小屋”选择一个组合方案。\r
\r
1. 指出研究对象。\r
2. 圈出改变的量和保持不变的量。\r
3. 记录一个现象或一组数据。\r
...
## 你发现了什么？\r
\r
现象支持的最短结论是：**能源方案要按需求比较稳定性、安全、环境和成本**。若证据不足，只写“目前支持”，不要把猜想当结论。\r
\r
## 把现象画出来，建立模型\r
\r
...
## 正式物理知识\r
\r
- 概念：能源方案要按需求比较稳定性、安全、环境和成本。\r
- 关系：本课无须背公式，先稳定概念和图。\r
- 本课不用计算公式。模型边界：需求—证据—约束—方案—评价。\r
- 先用图和证据判断，不把一句口诀套到所有情境。\r
\r
**信息阅读卡（2.4.6）**：广播、移动通信和卫星通信可利用电磁波传递信息；这里只建立用途联系，不增加波长公式计算。\r
\r
**跨学科项目卡（5.1—5.3）**：为节能小屋完成‘需求—证据—约束—方案—评价’五格表。至少比较能耗、安全、稳定性、材料和环境影响，不以单一指标下结论。\r
\r
## 一个典型例题\r
\r
**题目**：白天日照稳定、夜间用电持续，能否只装太阳能板？\r
\r
**六步建模**：对象是谁 → 已知什么 → 求什么 → 画最简图 → 选“需求—证据—约束—方案—评价” → 检查单位和意义。\r
\r
**答案**：不能只凭白天数据决定；还要考虑夜间供能、储能或备用电源。\r
\r
## 一句话收束\r
\r
今天记住：**能源方案要按需求比较稳定性、安全、环境和成本；需求—证据—约束—方案—评价。**\r
\r
## 10分钟练习\r
\r
1. **[基础·概念辨析]** 完成下面这项任务后，有同学的解释出现“把可再生能源等同于没有环境影响”。任务：读取太阳能、风能和市电的三项数据，只为“节能小屋”选择一个组合方案。请指出应补充或改正的关键条件。\r
\r
   **答案**：先按“需求—证据—约束—方案—评价”圈定研究对象和条件，再改正该判断；不能只写错误名称。\r
2. **[基础·读数/计算]** 白天日照稳定、夜间用电持续，能否只装太阳能板。\r
\r
   **答案**：不能只凭白天数据决定；还要考虑夜间供能、储能或备用电源。关键条件：对象、过程和单位必须配对。\r
3. **[典型·读图作图]** 围绕“方案评价矩阵”，标出研究对象、关键方向或变量，并用图得出“需求—证据—约束—方案—评价”这一结论。\r
\r
   **答案**：图中至少出现对象、方向/变量、条件和结论；箭头、刻度、虚实线必须符合物理意义。\r
4. **[典型·证据与实验]** 完成“读取太阳能、风能和市电的三项数据，只为“节能小屋”选择一个组合方案”时，写出要比较的对象、只改变或重点比较的条件，以及应记录的现象。\r
\r
   **答案**：围绕“需求—证据—约束—方案—评价”完成一次清楚比较：先定对象和条件，再记录能支持或否定“能源方案要按需求比较稳定性、安全、环境和成本”的现象；一次操作不能外推成普遍定律。\r
5. **[提升·解释论证]** 把下面的核心问题改成可检验的问题，并写出需要取得的证据：一种能源方案“能用”，是否就一定适合这个场景？\r
\r
   **答案**：先圈定对象和条件，再用“需求—证据—约束—方案—评价”连接证据与结论。如果出现“只看单一指标”，订正这个判断步骤后，再用一道同类题确认。\r
\r
## 为什么错\r
\r
- **只看单一指标**：重读题目，只圈出决定答案的条件，再作答。\r
- **把可再生能源等同于没有环境影响**：回到现象和核心句，用自己的话重新解释一次。\r
- **做题中途漏条件**：在题目旁画“对象—条件—单位”三格，完成一格勾一格。\r
\r
## 和上一课的关系\r
\r
